package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_681:Number = 64;
      ...
      private var var_368:Number = 1;
      
      private var _y:Vector3d;
      
      private var var_1381:Number = 1;
      
      private var var_69:int = 0;
      
      private var var_369:Map = null;
      
      private var var_932:Vector3d;
      ...
      private var var_1382:Number = 1;
      
      private var var_2317:Number = 500;
      
      private var var_1383:Number = 1;
      
      private var var_74:Vector3d;
      
      private var var_75:Vector3d;
      
      private var var_2318:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_75 = new Vector3d();
         var_932 = new Vector3d();
         var_1381 = 1;
         var_1383 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1382 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_203.assign(param1);
         if(var_203.x != _loc2_ || var_203.y != _loc3_ || var_203.z != _loc4_)
         {
            ++var_69;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            var_74.assign(_loc23_);
            _y.assign(_loc24_);
            var_75.assign(_loc25_);
         }
         else
         {
            var_74.assign(_loc18_);
            _y.assign(_loc19_);
            var_75.assign(_loc20_);
         }
      }
      
      public function set z_scale(param1:Number) : void
      {
         if(var_368 != param1 * var_1382)
         {
            var_368 = param1 * var_1382;
            ++var_69;
         }
      }
      ...
      {
         if(var_367 != param1 * var_1381)
         {
            var_367 = param1 * var_1381;
            ++var_69;
         }
      }
      ...
      {
         if(var_366 != param1 * var_1383)
         {
            var_366 = param1 * var_1383;
            ++var_69;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_369 != null)
         {
            ...
            var_369.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_369.add(_loc3_,_loc4_);
            ++var_69;
         }
      }
      ...
      {
         return new Vector3d(var_203.x,var_203.y,var_203.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_932.assign(_loc22_);
         }
         else
         {
            var_932.assign(_loc17_);
         }
         ++var_69;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_62);
         _loc2_.x *= var_367;
         _loc2_.y *= var_366;
         _loc2_.z *= var_368;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_932);
         if(_loc3_ < var_2318 || _loc3_ > var_2317)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,var_74);
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_62);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_367;
            _loc2_.y *= var_366;
            _loc2_.z *= var_368;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_932);
         }
      ...
      {
         return new Vector3d(0 * var_367,0 * var_366,0 * var_368);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.scalarProjection(param1,var_74);
         var _loc3_:Number = Vector3d.scalarProjection(param1,_y);
         var _loc4_:Number = Vector3d.scalarProjection(param1,var_75);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function get directionAxis() : IVector3d
      {
         return new Vector3d(var_75.x,var_75.y,var_75.z);
      }
      
      public function isZoomedIn() : Boolean
      {
         return scale == const_681;
      }
      
      public function get scale() : Number
      {
         return var_187 / Math.sqrt(0.5);
      }
      ...
      public function adjustLocation(param1:IVector3d, param2:Number) : void
      {
         ...
         var _loc3_:Vector3d = Vector3d.product(var_75,param2);
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var_62.y = 0 / var_366;
         var_62.z = 0 / var_368;
         if(var_62.x != _loc2_ || var_62.y != _loc3_ || var_62.z != _loc4_)
         {
            ++var_69;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_369 != null)
         {
            ...
            return var_369.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_187;
         var _loc6_:Number = -param1.y / var_187;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_74,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_367,0 * var_366,0 * var_368);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_75;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_367,param2.y * var_366,param2.z * var_368);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_367,param3.y * var_366,param3.z * var_368);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_367,param4.y * var_366,param4.z * var_368);
