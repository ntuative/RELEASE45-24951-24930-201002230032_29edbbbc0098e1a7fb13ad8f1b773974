package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_787:RoomObjectLocationCache;
      ...
      private var var_1859:Number = -10000000;
      
      private var var_1861:Number = -10000000;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_787 = new RoomObjectLocationCache(_loc6_);
         var_282 = new Map();
      ...
      public function update() : void
      {
         if(var_960 == 0)
         {
            checkMouseHits(var_958.x,var_958.y,MouseEvent.MOUSE_MOVE);
         }
         var_960 = 0;
         ++var_1413;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_246 != null)
         {
            var_246.graphics.clear();
         }
         else
         {
            var_246 = new Sprite();
            var_246.name = "mask";
            _master.addChild(var_246);
         }
         var_246.graphics.beginFill(0);
         var_246.graphics.drawRect(0,0,param1,param2);
         var_961 = param1;
         var_962 = param2;
         var_41.graphics.clear();
         var_41.graphics.beginFill(var_2319);
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - var_962 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc6_ < var_281.length)
         {
            var_281.splice(_loc6_);
         }
         var_281.sortOn("z",0 | 0);
         var _loc10_:* = null;
         var _loc11_:int = 0;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc10_ = var_281[_loc5_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         var_650.push(_loc12_ - _loc2_);
         if(var_650.length == const_740)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_740)
            {
               _loc13_ += var_650[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_462.length)
            {
               cleanSprite(var_462[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_462 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_282 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < var_282.length)
         {
            _loc2_ = var_282.getKey(_loc1_);
            _loc3_ = var_282.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_959 != null)
                  {
                     var_959.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1413,geometry);
                  }
                  else
                  {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return var_281[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_282 != null && param1 != null)
         {
            var_282.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_463.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_463.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1859 || param2 != var_1861)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_463.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_463.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_462.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:int) : int
      {
         ...
         var _loc6_:IVector3d = var_787.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc8_ += int(var_961 / 2);
         _loc9_ += int(var_962 / 2);
         ...
         while(_loc18_ < _loc7_)
         {
            ...
            if(_loc13_ != null && _loc13_.visible)
            {
               ...
               if(_loc19_ != null)
               {
                  ...
                  if(_loc14_ + _loc19_.width >= 0 && _loc14_ < var_961 && (_loc15_ + _loc19_.height >= 0 && _loc15_ < var_962))
                  {
                     if(_loc11_ < _loc17_)
                     {
                        _loc12_ = var_281[_loc11_];
                     }
                     else
                     {
                        _loc12_ = new SortableSprite();
                        var_281.push(_loc12_);
                     }
