package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_196:int = -1;
      
      private var var_168:Array;
      
      protected var var_269:int = -1;
      
      private var var_262:IRoomObject;
      
      protected var var_150:int = -1;
      ...
      {
         if(param1 >= 0 && param1 < var_168.length)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_168 != null)
         {
            while(false)
            {
               _loc1_ = var_168[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_168.length > param1)
         {
            _loc2_ = var_168["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
