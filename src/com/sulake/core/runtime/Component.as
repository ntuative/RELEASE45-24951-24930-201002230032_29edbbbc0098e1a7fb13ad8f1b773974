package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_861:uint = 4;
      ...
      protected var var_887:String = "";
      
      protected var var_172:InterfaceStructList;
      
      protected var var_2256:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_387:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_1642:Boolean = false;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1065 = param2;
         var_172 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_172.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_887 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_887);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1065 & const_861)
         {
            if(_loc3_ == 0)
            {
               if(var_172.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_172.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_387 + "]";
      }
   }
}
