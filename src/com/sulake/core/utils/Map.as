package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      {
         var _loc2_:Object = var_132[param1];
         if(_loc2_ == null)
         {
            return null;
         }
         var _loc3_:int = var_24.indexOf(_loc2_);
         if(_loc3_ >= 0)
         {
            var_24.splice(_loc3_,1);
            var_227.splice(_loc3_,1);
            --_length;
         }
         delete var_132[param1];
         return _loc2_;
      }
      ...
      public function unshift(param1:*, param2:*) : Boolean
      {
         ...
         var_132[param1] = param2;
         var_24.unshift(param2);
         var_227.unshift(param1);
         ++_length;
         return true;
      }
      ...
      override flash_proxy function getProperty(param1:*) : *
      {
         ...
         return var_132[param1];
      }
      
      public function reset() : void
      {
         var _loc1_:* = null;
         for(_loc1_ in var_132)
         {
            delete var_132[_loc1_];
         }
         _length = 0;
         var_24 = [];
         var_227 = [];
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         var_132[param1] = param2;
         var _loc3_:int = var_227.indexOf(param1);
         if(_loc3_ == -1)
         {
            var_24[_length] = param2;
            var_227[_length] = param1;
            ++_length;
         }
         else
         {
            var_24.splice(_loc3_,1,param2);
         }
      }
