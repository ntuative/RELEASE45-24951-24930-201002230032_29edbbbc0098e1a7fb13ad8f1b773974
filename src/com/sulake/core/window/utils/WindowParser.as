package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1528:String = "_INCLUDE";
      
      public static const const_824:String = "_EXCLUDE";
      
      public static const const_1559:String = "_TEMP";
      
      private static const const_1014:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1015:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1055:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_883:Dictionary;
      
      protected var var_1322:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1323:Dictionary;
      
      protected var var_1056:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         _context = param1;
         var_1056 = new Dictionary();
         var_1055 = new Dictionary();
         TypeCodeTable.fillTables(var_1056,var_1055);
         var_883 = new Dictionary();
         var_1323 = new Dictionary();
         ParamCodeTable.fillTables(var_883,var_1323);
         var_1322 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1015,"");
         return param1.replace(const_1014,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1056)
            {
               delete var_1056[_loc1_];
            }
            for(_loc1_ in var_1055)
            {
               delete var_1055[_loc1_];
            }
            for(_loc1_ in var_883)
            {
               delete var_883[_loc1_];
            }
            for(_loc1_ in var_1323)
            {
               delete var_1323[_loc1_];
            }
            var_1322.dispose();
            var_1322 = null;
            _context = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_146)
                     {
                        window.x = rect.x;
                     }
                     if((params & 0) == WindowParam.const_141)
                     {
                        window.y = rect.y;
                     }
                  }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_824) == -1)
                  {
