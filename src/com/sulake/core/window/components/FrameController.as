package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_753:String = "margin_top";
      
      private static const const_1082:String = "_HEADER";
      
      private static const const_750:String = "margin_right";
      
      private static const const_1085:String = "_SCALER";
      
      private static const const_1084:String = "_TITLE";
      
      private static const const_1083:String = "_CONTENT";
      
      private static const const_752:String = "margin_left";
      
      private static const const_751:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_60:IMargins;
      
      private var var_1324:Boolean = false;
      
      private var var_1241:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:* = var_60 != null;
         var _loc3_:Rectangle = content.rectangle;
         _loc1_.push(new PropertyStruct(const_752,_loc3_.left,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(const_753,_loc3_.top,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(const_750,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(const_751,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         return _loc1_;
      }
      ...
      public function get margins() : IMargins
      {
         ...
         if(!var_60)
         {
            ...
            var_60 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,marginsCallback);
         }
         return var_60;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_193);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_193,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_193,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1241 == null)
         {
            var_1241 = findChildByTag(const_1082) as IHeaderWindow;
            if(!var_1241)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1084) as ITextWindow;
            if(!_title)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_213,false);
         }
      ...
      {
         return content != null && var_1324 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_18 == null)
         {
            var_18 = findChildByTag(const_1083) as IWindowContainer;
            if(!var_18)
            {
