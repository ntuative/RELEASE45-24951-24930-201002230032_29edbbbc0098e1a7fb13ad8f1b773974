package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_736:IItemListWindow;
      
      private var var_311:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_311)
         {
            var_311 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_311)
            {
               var_311.addEventListener(WindowEvent.const_232,scrollBarEventProc);
               var_311.addEventListener(WindowEvent.const_171,scrollBarEventProc);
            }
         }
         return var_311;
      }
      ...
      override public function dispose() : void
      {
         if(var_311)
         {
            var_311.removeEventListener(WindowEvent.const_232,scrollBarEventProc);
            var_311.removeEventListener(WindowEvent.const_171,scrollBarEventProc);
            var_311 = null;
         }
         if(var_736)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_171)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_736)
         {
            var_736 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_736;
      }
