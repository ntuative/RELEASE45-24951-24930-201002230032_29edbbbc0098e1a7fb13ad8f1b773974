package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_998:String = "spacing";
      
      protected static const const_1378:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_997:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1377:Boolean = true;
      
      protected static const const_1000:String = "auto_arrange_items";
      ...
      protected var var_503:Number;
      
      protected var var_1061:Boolean = false;
      
      protected var var_501:Number;
      ...
      protected var var_712:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_82 = 0;
         var_59 = 0;
         _horizontal = param2 == WindowType.const_270;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_149 = var_711 || !testParamFlag(WindowParam.const_15);
         _container = _context.create("_CONTAINER","",WindowType.const_282,WindowStyle.const_264,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_274,containerEventHandler);
         _container.addEventListener(WindowEvent.const_379,containerEventHandler);
         resizeOnItemUpdate = var_1061;
      }
      ...
      {
         return new Rectangle(var_503 * maxScrollH,var_501 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_274,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_503 = param1;
            _container.x = -var_503 * maxScrollH;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_52);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_998,_spacing,PropertyStruct.const_41,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1000,var_712,PropertyStruct.const_39,var_712 != const_1377));
         _loc1_.push(new PropertyStruct(const_997,var_502,PropertyStruct.const_39,var_502 != const_1378));
         _loc1_.push(new PropertyStruct(const_999,var_1061,PropertyStruct.const_39,var_1061 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_501 = param1;
            _container.y = -var_501 * maxScrollV;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_52);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_999:
                  ...
                  break;
               case const_1000:
                  var_712 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         else
         {
            if(autoArrangeItems)
            {
               param1.y = var_59 + (numListItems > 0 ? _spacing : 0);
               var_59 = param1.rectangle.bottom;
            }
            else
            {
               var_59 = Math.max(var_59,param1.rectangle.bottom);
            }
            _container.height = var_59;
         }
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(var_502)
                     {
                        ...
                        var_59 = _loc3_ > var_59 ? Number(_loc3_) : Number(var_59);
                     }
                  }
                  _loc4_++;
               }
