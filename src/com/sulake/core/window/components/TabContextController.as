package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1079:String = "content";
      
      private static const const_1078:String = "selector";
       
      
      private var var_1218:Boolean = false;
      
      protected var var_892:ITabSelectorWindow;
      
      private var var_772:Boolean = false;
      
      protected var var_1558:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1558 == null)
         {
            var_1558 = findChildByTag(TabContextController.const_1079) as IWindowContainer;
         }
         return var_1558;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_892 == null)
         {
            var_892 = findChildByTag(TabContextController.const_1078) as ITabSelectorWindow;
            if(var_892 != null)
            {
               var_892.procedure = selectorEventProc;
            }
         }
         return var_892;
      }
      ...
      {
         return !!var_772 ? selector.iterator : null;
      }
