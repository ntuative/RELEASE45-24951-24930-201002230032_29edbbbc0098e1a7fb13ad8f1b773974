package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2313:Rectangle = new Rectangle();
       
      
      protected var var_197:Boolean;
      
      protected var var_60:TextMargins;
      
      protected var var_506:String = "none";
      
      protected var var_594:Number;
      
      protected var var_350:Number;
      
      protected var _field:TextField;
      
      protected var var_716:Boolean = false;
      ...
      {
         var_60 = new TextMargins(0,0,0,0,setTextMargins);
         var_197 = false;
         var_594 = 0;
         var_350 = 0;
         if(_field == null)
      ...
      {
         param1.var_60.dispose();
         param1.var_60 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_594 * maxScrollH,var_350 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_716)
         {
            context.removeLocalizationListener(var_301,this);
         }
         if(var_60 != null)
         {
            var_60.dispose();
      ...
      {
         var_594 = param1;
         _field.scrollH = var_594 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_301 = param1;
         if(var_301.charAt(0) == "$" && var_301.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_301.slice(2,var_301.indexOf("}")),this);
            var_716 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_197)
         {
            if(param2.type == WindowNotifyEvent.const_209)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_60.dispose();
            var_60 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_856,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_454,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_39,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_39,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_454,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_39,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_39,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_41,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_39,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_39,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_480,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_480,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_39,true));
         _loc1_.push(new PropertyStruct("margin_left",var_60.left,PropertyStruct.const_41,true));
         _loc1_.push(new PropertyStruct("margin_top",var_60.top,PropertyStruct.const_41,true));
         _loc1_.push(new PropertyStruct("margin_right",var_60.right,PropertyStruct.const_41,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_60.bottom,PropertyStruct.const_41,true));
         _loc1_.push(new PropertyStruct("auto_size",var_506,PropertyStruct.STRING,var_506 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_39,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_39,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_39,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_39,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_480,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_594 = var_594;
         _loc1_.var_350 = var_350;
         _loc1_.var_60 = var_60.clone(_loc1_.setTextMargins);
         _loc1_.var_506 = var_506;
         _loc1_.var_716 = var_716;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_506 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_506 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_506 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_506 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
