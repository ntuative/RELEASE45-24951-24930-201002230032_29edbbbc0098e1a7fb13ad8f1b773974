package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1086:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.const_1084) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.const_1086) as IItemListWindow;
      }
   }
}
