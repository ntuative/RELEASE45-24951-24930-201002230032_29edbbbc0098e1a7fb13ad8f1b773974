package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
      ...
      {
         setStateFlag(WindowState.const_30,param1);
      }
            ...
            if(var_6)
            {
               if(!(var_6 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_174,this,null));
                        break;
                     }
      ...
      {
         if(getStateFlag(WindowState.const_30))
         {
            return true;
         }
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_373,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         }
         setStateFlag(WindowState.const_30,true);
         _loc1_.type = WindowNotifyEvent.const_317;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         return testStateFlag(WindowState.const_30);
      }
      ...
      public function unselect() : Boolean
      {
         ...
         setStateFlag(WindowState.const_30,false);
         _loc1_.type = WindowNotifyEvent.const_559;
         update(this,_loc1_);
         return true;
      }
   }
