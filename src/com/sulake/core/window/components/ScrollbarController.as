package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1103:String = "increment";
      
      private static const const_478:String = "slider_bar";
      
      private static const const_1102:String = "decrement";
      
      private static const const_757:String = "slider_track";
      ...
      protected var var_715:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_149 = false;
         var_19 = param12;
         _horizontal = param2 == WindowType.const_367;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_478:
               if(param2.type == WindowNotifyEvent.const_230)
               {
                  if(!var_571)
                  {
                     if(_horizontal)
      ...
      {
         return findChildByName(ScrollbarController.const_757) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_19 != null && true)
         {
            IWindow(var_19).removeEventListener(WindowEvent.const_26,onScrollableResized);
         }
         var_19 = param1;
         if(var_19 != null && true)
         {
            IWindow(var_19).addEventListener(WindowEvent.const_26,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_478) as WindowController;
      }
      ...
      protected function setScrollPosition(param1:Number) : void
      {
         ...
         {
            _offset = param1;
            var_19.scrollH = _offset;
         }
         else
         {
            _offset = param1;
            var_19.scrollV = _offset;
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_856 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_856 != null)
         {
            _loc1_ = findParentByName(var_856) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_856) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1103)
            {
               if(var_19)
               {
                  var_571 = true;
            ...
            else if(param2.name == ScrollbarController.const_1102)
            {
               if(var_19)
               {
                  var_571 = true;
            ...
            else if(param2.name == ScrollbarController.const_757)
            {
               _loc4_ = new Point();
               ...
               if(_horizontal)
               {
                  ...
                  {
                     scrollH -= (var_19.visibleRegion.width - 0) / 0;
                  }
               ...
               {
                  scrollV -= (var_19.visibleRegion.height - 0) / 0;
               }
         ...
         if(param1.type == WindowMouseEvent.const_839)
         {
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:String = "";
         if(var_19 is IWindow)
         {
            _loc2_ = IWindow(var_19).name;
         }
         else if(var_856 != null)
         {
            _loc2_ = var_856;
         }
      ...
      private function updateLiftSizeAndPosition() : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_horizontal)
            {
               _loc1_ = Number(var_19.visibleRegion.width / var_19.scrollableRegion.width);
               if(_loc1_ > 1)
               {
                  _loc1_ = 1;
               }
            ...
            {
               _loc1_ = Number(var_19.visibleRegion.height / var_19.scrollableRegion.height);
               if(_loc1_ > 1)
               {
                  _loc1_ = 1;
               }
