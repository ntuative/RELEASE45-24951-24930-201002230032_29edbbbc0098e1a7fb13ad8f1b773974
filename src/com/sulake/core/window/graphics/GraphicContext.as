package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected static var var_597:uint = 0;
      
      protected static var var_352:uint = 0;
      
      public static const GC_TYPE_TEXTFIELD:uint = 2;
      
      public static const const_1512:uint = 128;
      
      public static const const_1473:uint = 64;
      ...
      protected var var_593:Boolean;
      
      protected var var_1563:Boolean;
      
      protected var var_151:DisplayObjectContainer;
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_593)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_352 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_151 = new Sprite();
            var_151.name = this.name + " - Child Container";
            var_151.mouseEnabled = false;
            addChild(var_151);
         }
         return var_151;
      }
         ...
         if(var_593)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_352 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1563,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1563,16777215);
                  }
                  var_352 += bitmap.width * bitmap.height * 4;
               }
