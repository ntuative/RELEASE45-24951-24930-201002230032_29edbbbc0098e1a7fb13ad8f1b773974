package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_41:DisplayObjectContainer;
      
      private var _disposed:Boolean;
      
      private var var_648:ISkinContainer;
      
      private var var_1508:Rectangle;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_566.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_617,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_295[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1509,var_1508))
            {
               if(param2.render(param1,var_1509,var_1508))
               {
                  ...
                  while(_loc7_ < _loc4_)
                  {
                     ...
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_15))
                        {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_648);
            var_295[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_617,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            if(param1.testParamFlag(WindowParam.const_15))
            {
               while(param1.testParamFlag(WindowParam.const_15))
               {
            ...
            getWindowRendererItem(param1).invalidate(param1,var_296,WindowRedrawFlag.const_225);
            if(var_566.indexOf(param1) == -1)
            {
               var_566.push(param1);
            }
         }
