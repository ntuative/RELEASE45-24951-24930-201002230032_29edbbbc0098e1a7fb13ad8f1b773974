package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_900:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_507:uint = 0;
      
      public static const const_910:String = "AssetLibraryReady";
      
      public static const const_1176:String = "AssetLibraryUnloaded";
      
      public static const const_441:String = "AssetLibraryLoaded";
      
      public static const const_1259:String = "AssetLibraryLoadError";
      ...
      private var var_12:LibraryLoader;
      
      private var var_354:Dictionary;
      ...
      private var var_422:Boolean = true;
      
      private var var_305:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_507;
         var_355 = new Dictionary(false);
         var_354 = new Dictionary(false);
         var_598 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_355)
         {
            _loc4_ = AssetTypeDeclaration(var_355[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_354)
         {
            _loc2_ = var_354[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_354[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_598)
         {
            delete var_598[_loc1_];
         }
         if(var_12 != null)
         {
            var_12.dispose();
         ...
         var_270 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1176));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_423 = _loc2_.manifest.copy();
         var_305 = _loc2_.resource;
         if(var_422)
         {
            AssetLibrary.fetchLibraryContents(this,var_423,var_305);
         }
         var_270 = true;
         dispatchEvent(new Event(AssetLibrary.const_441));
         dispatchEvent(new Event(AssetLibrary.const_910));
         if(var_422)
         {
            var_12.dispose();
            var_12 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_354[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_14,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_27,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_867,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_964,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_769,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_976,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_354[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_355.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_355[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_900.splice(var_900.indexOf(this),1);
            --var_507;
            var_354 = null;
            var_598 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_306.length ? getAssetByName(var_306[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1259));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_355)
         {
            _loc3_ = AssetTypeDeclaration(var_355[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_598[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(var_12 != null)
         {
            if(var_12.hasDefinition(param1))
            {
               _loc2_ = var_12.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  var_598[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_12 == null)
            {
               var_12 = new LibraryLoader(var_1329);
               var_12.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,libraryLoadedHandler);
               var_12.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            }
            var_422 = param2;
            _file = param1.url;
            var_12.load(param1,param3);
         }
         return var_12;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_423.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_305[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_354[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_14:
               ...
               if(decl != null)
               {
                  ...
                  {
                     asset.dispose();
                     e = new AssetLoaderEvent(AssetLoaderEvent.const_27,e.status);
                     break;
                  }
                  if(true)
                  {
                     ++var_173;
                     var_306.push(struct.assetName);
                  }
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_306.splice(var_306.indexOf(_loc2_),1);
      ...
      public function loadFromArchive(param1:URLRequest, param2:LoaderContext = null) : LibraryLoader
      {
         if(!(_file == param1.url && var_270))
         {
            ...
            var_12 = new ZipLoader(var_1329);
            var_12.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,archiveLoadedHandler);
            var_12.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            var_12.addEventListener(ProgressEvent.PROGRESS,onLoadProgress);
            var_422 = true;
            _file = param1.url;
            var_12.load(param1,param2);
         }
         return var_12;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_355[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_305 != null ? false : false;
      }
   }
}
