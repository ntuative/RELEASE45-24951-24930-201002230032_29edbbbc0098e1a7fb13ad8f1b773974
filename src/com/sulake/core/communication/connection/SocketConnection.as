package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1288:int = 10000;
      ...
      private var var_696:IEncryption;
      
      private var var_695:int;
      
      private var var_341:ByteArray;
      ...
      private var var_853:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_558 = param2;
         var_341 = new ByteArray();
         var_853 = new MessageClassManager();
         var_167 = new Socket();
         var_342 = new Timer(const_1288,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_853.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         ...
         if(var_696 != null)
         {
            _loc3_ = var_696.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         var_558.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_341.writeByte(var_167.readUnsignedByte());
         }
      }
      ...
      {
         var_853.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_568.getMessages(var_341,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_853.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_558.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_558.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_341,_loc2_);
            var_341 = _loc18_;
         }
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_696 + "\n");
      }
   }
}
