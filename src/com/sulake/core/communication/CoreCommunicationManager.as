package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_398:Dictionary;
      
      private var var_2079:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_398)
         {
            _loc10_;
            if(var_398[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_688[_loc3_];
      ...
      {
         if(param1 == null || var_398 == null)
         {
            return null;
         }
         return var_398[param1] as IConnection;
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1261)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = var_689[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_398)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      override public function dispose() : void
      {
         ...
         for each(_loc1_ in var_398)
         {
            _loc1_.dispose();
         }
         var_398 = null;
         var_689 = null;
         for each(_loc2_ in var_688)
         {
            while(true)
            {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_842:
               _loc3_ = new SocketConnection(param1,this,var_2079);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_398[param1] = _loc3_;
         return _loc3_;
      }
