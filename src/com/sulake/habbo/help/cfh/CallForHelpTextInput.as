package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1018:int = 30;
      
      private static const const_1017:int = 253;
      
      private static const const_1016:int = 10;
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "send":
               ...
               break;
            case "cancel":
               main.showUI(HabboHelpViewEnum.const_126);
               break;
            default:
