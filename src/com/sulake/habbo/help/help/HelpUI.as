package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1889:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24951-24930-201002222356");
         var_176 = param5;
         var_96 = new Map();
         var_96.add(HabboHelpViewEnum.const_1253,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_126,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_443,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_252,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_177,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_508,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_308,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_664,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_175,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         var_96.add(HabboHelpViewEnum.CALL_FOR_HELP_HAS_ABUSIVE_ITEM,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_abusive")));
         var_96.add(HabboHelpViewEnum.const_931,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_697,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_247 == HabboHelpViewEnum.const_126 || false)
         {
            return;
         }
         if(var_385 == null)
         {
            ...
            var_385 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_385 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_385 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_385 as IWindow);
      ...
      {
         return var_96.getValue(var_247);
      }
      
      public function get localization() : IHabboLocalizationManager
      {
         return var_26.localization;
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_96.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_96.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1890 = param1;
         var _loc2_:IHelpViewController = var_96.getValue(HabboHelpViewEnum.const_126) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_175:
               showUI(HabboHelpViewEnum.const_175);
               break;
            case CallForHelpResultEnum.const_765:
               showUI(HabboHelpViewEnum.const_931);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_247 == HabboHelpViewEnum.const_126)
         {
            return;
         }
         if(true)
         {
            ...
            var_548.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_548.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_385.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_548[1],var_548[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_548[0],var_548[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1424;
         _window.width = _loc1_.width + var_1423;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_96.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_247);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_176 != null)
            {
               var_176.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.HELP,_window));
            }
         }
         var_26.events.dispatchEvent(new Event(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT));
      }
      ...
      public function hideUI() : void
      {
         ...
         var_247 = var_1889;
         var_26.events.dispatchEvent(new Event(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED));
      }
      
      public function sendMessage(param1:IMessageComposer) : void
      {
         var_26.sendMessage(param1);
      }
      
      public function getFaq() : FaqIndex
      {
         return var_26.getFaq();
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_26.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_655));
      }
      ...
      {
         return var_26.getConfigurationKey(param1,param2,param3);
      }
   }
}
