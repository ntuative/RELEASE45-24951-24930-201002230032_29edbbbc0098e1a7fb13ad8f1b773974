package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_626:FaqCategory;
      
      private var var_625:FaqCategory;
      ...
      {
         super();
         var_625 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_626 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_119 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_625.hasItem(param1))
         {
            var_625.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_626.hasItem(param1))
         {
            var_626.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
