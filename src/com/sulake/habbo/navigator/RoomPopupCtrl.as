package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1953 = new RoomThumbnailRenderer(param1);
         var_975 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_162,var_109.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_162.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_162.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_975.refreshTags(_loc1_,var_109.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1953.refreshThumbnail(_loc1_,var_109.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_162 == null)
         {
            var_162 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_162.visible = true;
         Util.hideChildren(var_162);
         refreshRoomName(var_162,var_109);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_162,!true ? getEventCtg(var_109.categoryId) : getRoomCtg(var_109.categoryId));
         refreshRoomDesc(var_162,var_109);
         refreshExtraCont();
         refreshInfo(var_162,"trading_allowed",var_109.allowTrading);
         refreshInfo(var_162,"doormode_doorbell",false);
         refreshInfo(var_162,"doormode_password",false);
         Util.moveChildrenToColumn(var_162,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_162.height = Util.getLowestPoint(var_162);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_188,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
