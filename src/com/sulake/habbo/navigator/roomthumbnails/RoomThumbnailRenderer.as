package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1098:int = -16;
      
      private static const const_756:int = 32;
      
      private static const const_1100:int = 8;
      
      public static const const_331:int = 10;
      
      private static const const_1099:int = 40;
      ...
      private var var_854:ThumbnailImageConfigurations;
      
      private var var_1271:BitmapData;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_854 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_23,0 | (!!param3 ? HabboWindowParam.const_22 : HabboWindowParam.const_23),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_16,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1098,_loc4_.y + const_1099 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2113[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_18,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_854.getImage(ThumbnailEditorModel.const_18,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_756 + _loc3_,param2 * const_1100);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_331)
         {
            var_1017[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1017[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_331)
         {
            if(false)
            {
               refreshObj(param1,var_1017[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1271 == null)
         {
            var_1271 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1271,var_1271.rect,new Point(0,0),null,null,true);
      }
   }
}
