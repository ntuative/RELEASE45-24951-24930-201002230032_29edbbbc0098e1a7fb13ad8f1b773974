package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2358:Dictionary;
      ...
      private var var_336:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_2138:ISessionDataManager;
      
      private var var_2136:RoomCreateViewCtrl;
      
      private var var_1953:RoomThumbnailRenderer;
      
      private var var_176:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1284:RoomInfoViewCtrl;
      
      private var var_80:IHabboCatalog;
      
      private var var_395:Tabs;
      
      private var var_493:MainViewCtrl;
      
      private var var_2137:Array;
      
      private var var_1029:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_493 = new MainViewCtrl(this);
         var_1284 = new RoomInfoViewCtrl(this);
         var_2136 = new RoomCreateViewCtrl(this);
         var_1953 = new RoomThumbnailRenderer(this);
         var_1029 = new GuestRoomPasswordInput(this);
         var_336 = new GuestRoomDoorbell(this);
         var_395 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_493.startSearch(Tabs.const_207,Tabs.const_304,param1);
         var_493.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_176.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_176 != null)
         {
            var_176.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_176.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2138 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_493.startSearch(Tabs.const_227,Tabs.const_202);
         var_395.getTab(Tabs.const_227).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_493.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
