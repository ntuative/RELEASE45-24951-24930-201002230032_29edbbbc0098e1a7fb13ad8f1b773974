package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_425:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_425 == null ? 0 : int(var_425.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_263);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_613);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_263,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_425 == null)
         {
            var_425 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_425.procedure = onChangeFilter;
