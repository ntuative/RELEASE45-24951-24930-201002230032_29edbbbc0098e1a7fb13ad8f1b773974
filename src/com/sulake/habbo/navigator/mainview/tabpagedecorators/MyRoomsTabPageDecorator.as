package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_441:IDropMenuWindow;
      
      private var var_2332:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 3)
         {
            return Tabs.const_574;
         }
         if(param1 == 4)
         {
            return Tabs.const_518;
         }
      ...
      {
         var _loc1_:int = var_441 == null ? 0 : int(var_441.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_227,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_441 == null)
         {
            var_441 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_441.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
