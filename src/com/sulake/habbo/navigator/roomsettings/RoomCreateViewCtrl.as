package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_721:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1072 = new Timer(100);
         var_1072.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_54 = new Array();
         var_54.push(new RoomLayout(false,104,"a"));
         var_54.push(new RoomLayout(false,94,"b"));
         var_54.push(new RoomLayout(false,36,"c"));
         var_54.push(new RoomLayout(false,84,"d"));
         var_54.push(new RoomLayout(false,80,"e"));
         var_54.push(new RoomLayout(false,80,"f"));
         var_54.push(new RoomLayout(true,80,"g"));
         var_54.push(new RoomLayout(true,74,"h"));
         var_54.push(new RoomLayout(false,416,"i"));
         var_54.push(new RoomLayout(false,320,"j"));
         var_54.push(new RoomLayout(false,448,"k"));
         var_54.push(new RoomLayout(false,352,"l"));
         var_54.push(new RoomLayout(false,384,"m"));
         var_54.push(new RoomLayout(false,372,"n"));
         var_54.push(new RoomLayout(true,416,"o"));
         var_54.push(new RoomLayout(true,352,"p"));
         var_54.push(new RoomLayout(true,304,"q"));
         var_54.push(new RoomLayout(true,336,"r"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(var_18.findChildByName("back_button"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_18 = IWindowContainer(_navigator.getXmlWindow("roc_create_room"));
         var_44 = IItemListWindow(var_18.findChildByName("item_list"));
         ...
         var_903 = new TextFieldManager(_navigator,ITextFieldWindow(var_18.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_18.desktop,var_18.width,var_18.height);
         var_18.x = _loc2_.x;
         var_18.y = _loc2_.y;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_903.getText();
      ...
      {
         return IButtonWindow(var_18.findChildByName("create_button"));
      }
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(false)
         {
            _loc5_ = var_44.removeListItemAt(0);
            _loc5_.destroy();
         }
         for each(_loc1_ in var_54)
         {
            if(_loc1_.view != null)
            {
               _loc1_.view.destroy();
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_54.length)
         {
            _loc6_ = var_54[_loc4_];
            if(isAllowed(_loc6_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_54[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
         ...
         if(!_navigator.data.hcMember)
         {
            ...
            var_44.addListItem(_loc7_);
         }
         var_1588 = _navigator.data.hcMember;
      }
      ...
      {
         var_903.goBackToInitialState();
         var_903.input.textBackgroundColor = 4294967295;
         var_721 = var_54[0];
         if(var_1588 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_37,HabboWindowStyle.const_20,HabboWindowParam.const_49,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_903.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_721.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1071 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1071 = true;
            _loc3_.y = 1;
