package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2320:String = "magic.pixels";
      
      private var var_2321:String = "catalog.page.club";
      
      private var var_2343:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_251 = [];
         var_44 = _container.findChildByName("navigationList") as IItemListWindow;
         ...
         _loc3_.addEventListener(WindowMouseEvent.const_11,onNavigatorEvent);
         ...
         _loc4_.addEventListener(WindowMouseEvent.const_11,onNavigatorEvent);
         ...
         _loc5_.addEventListener(WindowMouseEvent.const_11,onNavigatorEvent);
         _scrollBar = _container.findChildByName("navigationListScrollbar") as IScrollbarWindow;
         if(_scrollBar != null)
         {
            _scrollBar.visible = false;
            _scrollBar.addEventListener(WindowEvent.const_565,activateScrollbar);
            ...
            _scrollBar.addEventListener(WindowEvent.const_171,deActivateScrollbar);
         }
      }
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_80.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_80.configuration.getKey("link.format.credits","/credits");
            var_80.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_80.openCatalogPage(var_2321,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_251.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_251)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_251.indexOf(_loc6_);
            var_251.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_44);
            }
         }
      }
