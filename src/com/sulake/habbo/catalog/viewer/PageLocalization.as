package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_161:Dictionary = new Dictionary();
      
      private static const const_727:Object = {"frontpage3":[7,8]};
      
      private static const const_1039:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      ...
      {
         const_161["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_161["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_161["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_161["collectibles"] = ["ctlg_collectibles_link"];
         const_161["club1"] = ["ctlg_text_5"];
      }
      ...
      {
         if(param1 < var_754.length)
         {
            return var_754[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_522.length)
         {
            _loc2_ = String(var_522[param1]).replace("#","0x");
