package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1187:IProductData;
      ...
      {
         super();
         var_1188 = param1.productType;
         var_1190 = param1.furniClassId;
         var_980 = param1.extraParam;
         var_979 = param1.productCount;
         var_1189 = param1.expiration;
         var_1187 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_56:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_980);
               break;
