package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_578[var_1031] as Array;
      ...
      {
         var _loc2_:Offer = var_578[var_1031][var_2169];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_389 || _loc1_.pricingModel == Offer.const_381)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_56 || _loc3_.productType == ProductTypeEnum.const_58)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1030.indexOf(_loc5_) == -1)
                        {
                           var_1030.push(_loc5_);
                           var_578.push(new Array());
                        }
                        _loc6_ = var_1030.indexOf(_loc5_);
                        (var_578[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_578)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_578)
         {
            if(var_2169 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2169] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1031 = var_894.getGridItemIndex(param1.view);
