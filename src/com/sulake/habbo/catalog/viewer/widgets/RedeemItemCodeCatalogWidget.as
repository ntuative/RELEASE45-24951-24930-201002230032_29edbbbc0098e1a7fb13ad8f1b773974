package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1024 != null)
         {
            var_1024.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1023 != null)
         {
            var_1023.removeEventListener(WindowKeyboardEvent.const_133,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1024 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1024 != null)
         {
            var_1024.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1023 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1023 != null)
         {
            var_1023.addEventListener(WindowKeyboardEvent.const_133,windowKeyEventProcessor);
         }
      }
