package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_936:ITextFieldWindow;
      ...
      {
         super.init();
         var_936 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_936 != null)
         {
            var_936.addEventListener(WindowKeyboardEvent.const_706,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_936.text));
      }
   }
}
