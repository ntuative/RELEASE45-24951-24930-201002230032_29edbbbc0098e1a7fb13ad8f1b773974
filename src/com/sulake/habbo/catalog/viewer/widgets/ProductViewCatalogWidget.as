package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1448:Point;
      
      private var var_1939:Array;
      
      private var var_552:IItemGridWindow;
      
      private var var_78:IBitmapWrapperWindow;
      
      private var var_1206:ITextWindow;
      
      private var var_1209:IScrollbarWindow;
      
      protected var var_1330:XML;
      
      private var var_1210:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_552 != null)
         {
            var_552.visible = false;
            var_552.destroyGridItems();
         }
         if(var_1209 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1206.text = "${" + _loc3_.name + "}";
            var_1205.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1206.text = "${" + _loc2_.localizationId + "}";
            var_1205.text = "${" + _loc2_.localizationId + "}";
         }
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            setPreviewFromAsset(ProductImageConfiguration.const_17[_loc2_.localizationId]);
         }
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_460:
                  _loc4_ = var_1210.clone();
                  if(var_552 != null)
                  {
                     var_552.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_552,var_1209,var_1330);
                  }
                  break;
               ...
               case Offer.const_381:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_199:
                        ...
                        _loc4_ = new BitmapData(var_78.width,var_78.height,false,_loc10_);
                        _loc11_ = null;
                        _loc12_ = page.viewer.catalog as HabboCatalog;
                        if(_loc12_.avatarRenderManager != null)
                        {
                           _loc14_ = _loc12_.sessionDataManager.figure;
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_33);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_28,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_300,AvatarAction.const_487);
                              _loc13_.appendAction(AvatarAction.const_643,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_21);
      ...
      {
         var_1206 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1205 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_78 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1448 = new Point(var_78.x,var_78.y);
         var_552 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1209 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_552 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1330 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1210 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_78);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_14,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_78.bitmap = new BitmapData(var_78.width,var_78.height,true,16777215);
         }
         var_78.bitmap.fillRect(var_78.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_78.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_78.invalidate();
         var_78.x = var_1448.x;
         var_78.y = var_1448.y;
         if(param2 != null)
