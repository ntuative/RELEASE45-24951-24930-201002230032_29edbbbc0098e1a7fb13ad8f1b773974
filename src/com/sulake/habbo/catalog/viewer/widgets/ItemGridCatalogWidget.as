package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_275:IGridItem;
      ...
      override public function dispose() : void
      {
         ...
         {
            var_169.stop();
            var_169.removeEventListener(TimerEvent.TIMER,populateItemGrid);
            var_169 = null;
         }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_846 >= 0 && var_846 < page.offers.length)
            {
               _loc4_ = page.offers[var_846];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++var_1491;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1491);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_120)
         {
            var_169 = new Timer(25);
            var_169.addEventListener(TimerEvent.TIMER,populateItemGrid);
            var_169.start();
         }
      }
