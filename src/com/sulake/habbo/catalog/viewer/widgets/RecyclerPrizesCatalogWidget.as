package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1723:XML;
      
      private var var_275:IGridItem;
      
      private var var_1330:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_746:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_627.length)
         {
            createLevelItem(var_627[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_746 = new PrizeViewer();
         var_517 = new Map();
         var_627 = recycler.getPrizeTable();
         if(var_627 == null)
         {
            return;
         }
         ...
         var_1723 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_627[0].prizes.length > 0)
         {
            select(var_627[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1723) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1330) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_746.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
