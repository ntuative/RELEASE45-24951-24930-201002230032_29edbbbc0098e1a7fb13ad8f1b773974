package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1005 + var_1005 / -var_2325 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_847 - var_847 / var_397 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_397).toString().length - 1);
         var_397 = Math.ceil(var_397 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_397.toString();
         _loc3_.draw(_loc6_);
         var_1005 = param1 - _loc6_.textWidth - 2;
         var_847 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_847);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_847 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1005 - 1,_loc4_);
            _loc10_++;
         }
         _loc9_.graphics.lineStyle(2,255);
         _loc9_.graphics.moveTo(getX(0),getY(0));
         _loc10_ = 1;
         while(_loc10_ < var_74.length)
         {
            _loc9_.graphics.lineTo(getX(_loc10_),getY(_loc10_));
            _loc10_++;
         }
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1005,(param2 - var_847) / 2));
         return _loc3_;
      }
      
      public function get available() : Boolean
      {
         return var_74 && _y && false;
      }
   }
}
