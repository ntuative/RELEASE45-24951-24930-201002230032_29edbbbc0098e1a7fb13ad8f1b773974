package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_95:IMarketPlace;
      ...
      private var var_276:CatalogViewer;
      
      private var var_1827:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_380:ICatalogNavigator;
      
      private var var_1076:IAvatarRenderManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_76:RecyclerLogic;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_1829:GiftWrappingConfiguration;
      ...
      private var var_946:ClubGiftController;
      ...
      {
         return var_514.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_184.credits = _loc3_.balance;
         updatePurse();
         if(!var_1828 && var_806 != null)
         {
            var_806.playSound(HabboSoundTypesEnum.const_833);
         }
         var_1828 = false;
      }
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_58)
         {
            _loc3_ = var_514.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_56)
         {
            _loc3_ = var_514.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_76 == null)
         {
            return;
         }
         var_76.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_75:
               var_1145 = param1.session.isPrivateRoom;
               if(var_76 != null)
               {
                  var_76.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_85:
               ...
               if(var_76 != null)
               {
                  var_76.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_76.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_160.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_160.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1829 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_176 != null && _loc2_)
         {
            var_176.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_76 != null && getCurrentLayoutCode() == "recycler")
            {
               var_76.activate();
            }
         }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_178,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_946.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_380 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      {
         var_76 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_184.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_184.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_946 == null)
         {
            var_946 = new ClubGiftController(this);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_95.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_95 == null)
         {
            var_95 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         var_176.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_380.buildCatalogIndex(_loc2_);
         if(var_947 != "")
         {
            var_380.openPage(var_947);
            var_947 = "";
         }
         else
         {
            var_380.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_155)
         {
            _loc3_ = var_160.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_276 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_276.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_76.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_184.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_184.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_184.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_184.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_276.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_184.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1827 && var_806 != null)
         {
            var_806.playSound(HabboSoundTypesEnum.const_795);
         }
         var_1827 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_276.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_276.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_276 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_276.habboCatalog = this;
      }
