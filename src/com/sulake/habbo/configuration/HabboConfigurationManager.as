package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private var var_1040:Dictionary;
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         (_context as CoreComponent).error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,CoreComponent.const_1187);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1040[param1] as String;
         return _loc2_ != null;
      }
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1542.indexOf(param1) < 0)
         {
            var_1040[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_772 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_144));
         if(var_2207)
         {
      ...
      {
         var _loc4_:String = var_1040[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_2206);
      ...
      private function init() : void
      {
         ...
         if(!var_772)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_14,onInitConfiguration);
            _loc4_.addEventListener(AssetLoaderEvent.const_27,onConfigurationError);
         }
      }
