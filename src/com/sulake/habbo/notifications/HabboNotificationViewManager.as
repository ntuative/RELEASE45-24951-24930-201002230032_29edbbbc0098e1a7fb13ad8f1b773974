package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_474:int = 4;
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_474;
         var _loc2_:int = 0;
         while(_loc2_ < var_216.length)
         {
            _loc3_ = var_216[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_591 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_591 + const_474;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2001,var_406,var_176);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_591 < 540;
      }
   }
}
