package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1620 = param2;
         var_514 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_91,onBadgeImageReady);
         ...
         var_180 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1621 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_180);
      ...
      public function dispose() : void
      {
         if(var_514 != null)
         {
            var_514.events.removeEventListener(BadgeImageReadyEvent.const_91,onBadgeImageReady);
            var_514 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_607,var_1621);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_607,var_607));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_607,var_607));
         _localizations.registerParameter(param1,"level",var_1620.toString());
         _localizations.registerParameter(param1,"name",var_514.userName);
         _localizations.registerParameter(param1,"realname",var_514.realName);
      }
   }
}
