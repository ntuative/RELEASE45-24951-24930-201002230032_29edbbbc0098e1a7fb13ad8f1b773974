package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1007:String = "badges";
      
      private static const const_1012:String = "pixelbalance";
      
      private static const const_1013:String = "credits";
      
      private static const const_1009:String = "inventory";
      
      private static const const_1008:String = "friendlist";
      
      private static const const_1010:String = "selectfurni";
      
      private static const const_1011:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_508:ParkBusDialogManager;
      
      private var var_1074:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_357:HabboNotificationViewManager;
      ...
      private var var_174:HabboAlertDialogManager;
      
      private var var_601:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_723);
         }
         var _loc6_:Map = var_723["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1247);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_601 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,var_80);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_174 == null)
         {
            return;
         }
         var_174.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1294);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_174.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_174.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1183);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1596)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_843);
            var_1596 = true;
      ...
      {
         if(param1 != null && this.var_357 != null)
         {
            var_357.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc2_,NotificationType.const_1266);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1076.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_33);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_21,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_28).clone();
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_884,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_155 || param2.type == WindowEvent.const_680)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_357.isSpaceAvailable() && false)
         {
            var_357.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_508 == null)
         {
            var_508 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_508 != null)
         {
            var_508.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_904.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1076.createPetImage(_loc2_.figure,AvatarScaleType.const_33);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_514);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc15_.productType == CatalogPageMessageProductData.const_58)
               {
                  _loc16_ = var_514.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_56)
               {
                  _loc16_ = var_514.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_514.getProductData(_loc4_.localizationId);
               switch(_loc15_.productType)
               {
                  case CatalogPageMessageProductData.const_58:
                     ...
                     break;
                  case CatalogPageMessageProductData.const_56:
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_843,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1076.createAvatarImage(param2,AvatarScaleType.const_33);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_28,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_28);
         }
         if(param3 == "")
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_183);
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_174 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_1074 = IHabboToolbar(param2);
         var_1074.events.addEventListener(HabboToolbarEvent.const_63,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_174.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_514.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_798);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_798);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_174.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_63)
         {
            ...
            var_357 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_723["styles"],var_723["view"],var_1074);
            ...
            registerUpdateReceiver(var_357,1);
            registerUpdateReceiver(this,2);
            var_514.events.addEventListener(BadgeImageReadyEvent.const_91,onBadgeImage);
            var_1074.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
