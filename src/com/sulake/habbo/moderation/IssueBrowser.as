package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1615:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1613:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1494:IIssueBrowserView;
      
      private const const_1622:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1614:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_221:ITabContextWindow;
      
      private var var_1495:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_334.view.width = var_221.container.width;
         var_334.view.height = var_221.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1614:
               if(var_1494 == null)
               {
                  var_1494 = new MyIssuesView(issueManager,this,var_221.container);
               }
               return var_1494;
            case const_1615:
               if(var_1493 == null)
               {
                  var_1493 = new OpenIssuesView(issueManager,this,var_221.container);
               }
               return var_1493;
            case const_1613:
               if(var_1495 == null)
               {
                  var_1495 = new PickedIssuesView(issueManager,this,var_221.container);
               }
               return var_1495;
            default:
               return null;
