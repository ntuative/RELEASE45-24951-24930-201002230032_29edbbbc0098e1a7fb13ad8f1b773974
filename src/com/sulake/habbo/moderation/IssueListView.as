package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2347:BitmapData;
      
      private var var_2346:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_44 = param3;
         var_1129 = param4;
         var_1441 = var_509.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1441 == null)
            {
               return;
            }
            _loc2_ = var_1441.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = var_44.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_509.assets.getAssetByName(_loc8_) as BitmapDataAsset;
