package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1340:IMessageComposer;
      ...
      {
         var_802 = IWindowContainer(var_42.getXmlWindow("chatlog_roomheader"));
         var_801 = IWindowContainer(var_42.getXmlWindow("chatlog_chatline"));
         var_466 = new Timer(300,1);
         var_466.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_46 = IFrameWindow(var_42.getXmlWindow("chatlog_frame"));
         ...
         var_42.connection.send(var_1340);
         var_42.messageHandler.addChatlogListener(this);
      }
      ...
      public function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         ...
         var_42.messageHandler.removeChatlogListener(this);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_802.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_46,var_42,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_801.clone());
         _loc4_.color = var_1171[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_46,var_42,_loc6_,param2.chatterId);
         }
