package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_977:String = "issue_bundle_open";
      
      public static const const_661:String = "issue_bundle_my";
      
      public static const const_967:String = "issue_bundle_picked";
      ...
      private var var_509:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_113 = new Map();
         var_725 = new Map();
         var_509 = new IssueBrowser(this,var_48.windowManager,var_48.assets);
         var_603 = [];
         var_724 = [];
         var_908 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_908.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in var_113)
         {
            switch(param1)
            {
               case const_977:
                  if(_loc4_.state == IssueMessageData.const_117)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      {
         var _loc2_:IssueBundle = var_113.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_603 = var_603.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var_136.remove(param1.issueId);
         var_136.add(param1.issueId,param1);
         var _loc2_:int = int(var_725.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_113.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_113.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_725.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1117)
         {
            var_136.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_113)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_725.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_725.add(param1.issueId,_loc2_);
            var_113.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_603.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_117)
         {
            _loc5_ = getBundles(const_661);
            _loc6_ = false;
            ...
            _loc8_ = var_724.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_908.remove(param1);
         var_908.add(param1,_loc3_);
      ...
      {
         var _loc3_:IssueBundle = var_113.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_908.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_113.getValues();
         for each(_loc3_ in _loc1_)
         {
            if(_loc3_.state == IssueMessageData.const_117 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_509 == null || !var_509.isOpen())
         {
            var_48.soundManager.playSound(HabboSoundTypesEnum.const_889);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_725.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_113.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_113.getValues();
