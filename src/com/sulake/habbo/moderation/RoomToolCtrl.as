package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_986:ICheckBoxWindow;
      ...
      private var var_662:ICheckBoxWindow;
      
      private var var_46:IFrameWindow;
      
      private var var_987:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_42,WindowTracker.const_674,_data.flatId),var_46,false,false,true);
      }
      ...
      private function setSendButtonState(param1:String) : void
      {
         ...
         if(_loc2_ && var_42.initMsg.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("MSG TEMPLATES: " + var_42.initMsg.roomMessageTemplates.length);
         param1.populate(var_42.initMsg.roomMessageTemplates);
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_42.messageHandler.removeRoomEnterListener(this);
         if(var_46 != null)
         {
            var_46.destroy();
            var_46 = null;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_44.getListItemByName(param2));
         var _loc4_:IWindowContainer = IWindowContainer(_loc3_.findChildByName("room_data"));
         if(_loc4_ == null)
         {
            _loc4_ = IWindowContainer(var_42.getXmlWindow("roomtool_roomdata"));
            _loc3_.addChild(_loc4_);
         }
         if(!param1.exists)
         {
            var_44.removeListItem(_loc3_);
            var_44.removeListItem(var_44.getListItemByName("event_spacing"));
            return;
         }
      ...
      public function onRoomInfo(param1:RoomModerationData) : void
      {
         ...
         _data = param1;
         populate();
         var_42.messageHandler.removeRoomInfoListener(this);
         var_46.visible = true;
         var_42.messageHandler.addRoomEnterListener(this);
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.openHkPage("roomadmin.url","undefined");
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.windowTracker.show(new UserInfoFrameCtrl(var_42,_data.ownerId),var_46,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_662.isSelected);
         var_42.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1351,_loc2_,var_389.text,"",""));
         if(false)
         {
            var_42.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_986.isSelected,var_987.isSelected,var_662.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_42.initMsg.roomMessageTemplates["null"];
         if(_loc3_ != null)
         {
            var_289 = false;
            var_389.text = _loc3_;
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1246);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1182);
      }
      
      public function populate() : void
      {
         var_44 = IItemListWindow(var_46.findChildByName("list_cont"));
         ...
         var_662 = ICheckBoxWindow(var_46.findChildByName("kick_check"));
         var_986 = ICheckBoxWindow(var_46.findChildByName("lock_check"));
         var_987 = ICheckBoxWindow(var_46.findChildByName("changename_check"));
         ...
         var_42.disableButton(var_42.initMsg.bobbaFilterPermission,var_46,"bobba_filter_but");
         var_42.disableButton(var_42.initMsg.chatlogsPermission,var_46,"chatlog_but");
         if(!var_42.initMsg.roomKickPermission)
         {
            var_662.disable();
         }
      ...
      private function onBobbaFilter(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.openHkPage("wordfilter.url","");
      }
      
      public function show() : void
      {
         var_46 = IFrameWindow(var_42.getXmlWindow("roomtool_frame"));
         var_42.messageHandler.addRoomInfoListener(this);
         var_42.connection.send(new GetModeratorRoomInfoMessageComposer(var_405));
