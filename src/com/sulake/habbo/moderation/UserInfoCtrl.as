package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_723:int = 31536000;
      
      private static const const_725:int = 86400;
      
      private static const const_724:int = 3600;
      
      private static const const_722:int = 60;
      ...
      {
         if(param1 < 2 * const_722)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_724)
         {
            return Math.round(param1 / const_722) + " mins ago";
         }
         if(param1 < 2 * const_725)
         {
            return Math.round(param1 / const_724) + " hours ago";
         }
         if(param1 < 2 * const_723)
         {
            return Math.round(param1 / const_725) + " days ago";
         }
         return Math.round(param1 / const_723) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_42,WindowTracker.const_957,_data.userId),_callerFrame,var_927,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_753.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_42.getXmlWindow("user_info"));
            var_753.addChild(_loc1_);
            var_42.disableButton(var_42.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_42.disableButton(var_42.initMsg.alertPermission,_loc1_,"message_but");
            var_42.disableButton(var_42.initMsg.alertPermission || var_42.initMsg.kickPermission || var_42.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.windowTracker.show(new ModActionCtrl(var_42,_data.userId,_data.userName,var_1221),_callerFrame,var_927,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.windowTracker.show(new RoomVisitsCtrl(var_42,_data.userId),_callerFrame,var_927,false,true);
      }
      ...
      {
         var_42.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_42.messageHandler.addUserInfoListener(this);
         var_42.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_42.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_42 = null;
         _data = null;
         var_753 = null;
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_42.windowTracker.show(new SendMsgsCtrl(var_42,_data.userId,_data.userName,var_1221),_callerFrame,var_927,false,true);
      }
