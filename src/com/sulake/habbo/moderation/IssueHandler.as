package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_360:UserInfoCtrl;
      
      private var var_48:ModerationManager;
      
      private var var_920:UserInfoCtrl;
      
      private var var_102:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.releaseBundle(var_102.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc1_:XmlAsset = var_48.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         _window = var_48.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(_window == null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_26,onResized);
         }
         ...
         var_48.disableButton(var_48.initMsg.chatlogsPermission,_window,"show_chatlog");
         _loc2_ = _window.findChildByName("move_to_player_support");
         if(_loc2_ != null)
         {
            _loc2_.disable();
         }
         var _loc3_:IssueMessageData = var_102.getHighestPriorityIssue();
         var_360 = new UserInfoCtrl(_window,var_48,_loc3_.message);
         var_920 = new UserInfoCtrl(_window,var_48,_loc3_.message);
         var_360.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_102.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_920.load(_loc4_,var_102.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.closeBundle(var_102.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = var_48.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = var_48.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
         var _loc4_:Array = var_102.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_102.getHighestPriorityIssue().issueId;
         var_48.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_48,WindowTracker.const_819,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_48 != null && false && var_102 != null)
         {
            var_48.issueManager.removeHandler(var_102.id);
         }
         this.dispose();
      }
      ...
      {
         if(_window == null || var_48 == null || true)
         {
            return;
         }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_102.getHighestPriorityIssue();
            var_360 = new UserInfoCtrl(_window,var_48,_loc3_.message);
            var_360.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.closeBundle(var_102.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.closeBundle(var_102.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = var_48.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = var_48.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return WindowTracker.const_1283;
      }
   }
}
