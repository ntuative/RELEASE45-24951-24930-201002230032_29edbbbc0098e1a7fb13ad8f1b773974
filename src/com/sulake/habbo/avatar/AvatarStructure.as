package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_408:PartSetsData;
      
      private var var_2184:PartOffsetData;
      
      private var var_871:AvatarActionManager;
      
      private var var_147:IAssetLibrary;
      
      private var var_2283:IAssetLibrary;
      
      private var var_1324:Boolean = false;
      
      private var var_2183:AvatarRenderManager;
      
      private var var_497:FigureData;
      ...
      private var var_1528:AvatarStructureDownloadSet;
      
      private var var_703:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_147 = param2;
         var_2283 = param3;
         var_497 = new FigureData();
         var_408 = new PartSetsData();
         _animationData = new AnimationData();
         var_1528 = new AvatarStructureDownloadSet();
         var_703 = new AnimationManager();
         var_704 = param4;
         var_2184 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_871.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_704)
         {
            case AvatarType.const_76:
               _loc1_ = var_147.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_408.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_147.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_147.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_497.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_147.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_408.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_147.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_147.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_497.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_871.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_871.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_703.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_408.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_408.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1332[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_871.getDefaultActionType();
         var _loc7_:Array = var_408.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_703.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_497.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_497.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_408.getPartDefinition(_loc26_.type);
                           _loc30_ = _loc13_ == null ? _loc26_.type : _loc13_.flippedSetType;
                           if(_loc30_ == "")
                           {
                              _loc30_ = _loc26_.type;
                           }
                           if(_loc22_.length > _loc26_.subColorIndex - 1)
                           {
                              _loc31_ = _loc24_.getColor(_loc22_[_loc26_.subColorIndex - 1]);
                           }
                           _loc32_ = _loc26_.subColorIndex > 0;
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_408.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_76:
               if(var_147.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_147.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_147.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_147.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_704 + " ready to go!");
         if(var_704 == AvatarType.const_76)
         {
            var_408.getPartDefinition("ri").appendToFigure = true;
            var_408.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_76:
               var_1528.add(new AvatarStructureDownload(var_147,_loc5_,var_497));
               break;
            case AvatarType.PET:
         }
         var_1528.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_703.getAnimation(param1);
      }
      ...
      {
         var_871 = new AvatarActionManager(var_147,var_704);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_147.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_147.getAssetByName("dance" + _loc1_).content as XML;
            var_703.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_147.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_147.getAssetByName("fx" + _loc1_).content as XML;
            var_703.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_497.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_497.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_871.sortActions(param1);
      }
   }
}
