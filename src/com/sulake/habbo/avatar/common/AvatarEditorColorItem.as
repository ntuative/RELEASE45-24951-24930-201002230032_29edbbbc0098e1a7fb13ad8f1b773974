package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1596:int = 8947848;
      
      private const const_1595:int = 13421772;
      ...
      private var var_843:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_604.width,var_604.height,true,0);
            _loc1_.bitmap.copyPixels(var_604,var_604.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1077.width,var_1077.height,true,0);
            _loc4_ = var_1077.clone();
            _loc4_.colorTransform(_loc4_.rect,var_843.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_909.width,var_909.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_909,var_909.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1486,var_1486.rect,new Point(0,0),null,null,true);
            }
         }
      }
