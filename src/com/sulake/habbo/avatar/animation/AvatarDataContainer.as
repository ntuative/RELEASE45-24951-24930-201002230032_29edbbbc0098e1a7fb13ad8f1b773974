package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1435,var_1433,var_1434,_alphaMultiplier);
         var_916 = generatePaletteMapForGrayscale(var_1623,var_1622);
      }
      
      public function get reds() : Array
      {
         return var_916.getValue("reds") as Array;
      }
      ...
      {
         return var_916.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_916.getValue("greens") as Array;
      }
      ...
      {
         return var_916.getValue("alphas") as Array;
      }
