package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_699["null"] = new AvatarEditorGridView(param1,FigureData.const_111,param2,param3);
         var_699["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         var_699["null"] = new AvatarEditorGridView(param1,FigureData.const_135,param2,param3);
         var_699["null"] = new AvatarEditorGridView(param1,FigureData.const_128,param2,param3);
         var_699["null"] = new AvatarEditorGridView(param1,FigureData.const_136,param2,param3);
         attachImages();
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_accessories":
                  ...
                  break;
               case "tab_eyewear":
                  switchCategory(FigureData.const_128);
                  break;
               case "tab_masks":
