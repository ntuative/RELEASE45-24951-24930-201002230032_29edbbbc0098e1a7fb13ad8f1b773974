package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1838 = parseInt(param1.@precedence);
         var_1840 = String(param1.@activepartset);
         var_1842 = String(param1.@assetpartdefinition);
         var_1843 = String(param1.@lay);
         var_1275 = String(param1.@geometrytype);
         var_1837 = Boolean(parseInt(param1.@main));
         var_1841 = Boolean(parseInt(param1.@name_1));
         var_1839 = Boolean(parseInt(param1.@animation));
      ...
      {
         return var_1152.concat(getTypePrevents(param1));
      }
