package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_907:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_2106:IStructureData;
      
      private var var_1512:XML;
      ...
      public function AvatarStructureDownload(param1:IAssetLibrary, param2:String, param3:IStructureData)
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_14,onDataComplete);
      }
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1512 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_2106.append(var_1512);
         dispatchEvent(new Event(AvatarStructureDownload.const_907));
      }
   }
}
