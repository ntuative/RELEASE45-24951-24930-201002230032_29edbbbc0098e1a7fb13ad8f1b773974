package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_741:uint = 11;
       
      
      private var var_211:LatencyTracker = null;
      
      private var var_210:PerformanceTracker = null;
      
      private var var_472:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_386:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_969:int = -1;
      
      private var var_1174:LagWarningLogger = null;
      
      private var var_803:IHabboWindowManager;
      ...
      private var var_161:IHabboFriendList;
      ...
      private var var_52:IRoomWidgetFactory;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_210 = new PerformanceTracker();
         var_211 = new LatencyTracker();
         var_1174 = new LagWarningLogger();
         var_1175 = new Array(const_741);
         var _loc4_:int = 0;
         while(_loc4_ < const_741)
         {
            var_1175[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1350,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1263,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1161,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_507,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_840,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1325);
               break;
            case HabboCommunicationEvent.const_679:
               trackLoginStep(HabboLoginTrackingStep.const_1236,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_200:
               trackLoginStep(HabboLoginTrackingStep.const_200);
               break;
            case HabboCommunicationEvent.const_154:
               trackLoginStep(HabboLoginTrackingStep.const_154);
               break;
            case HabboCommunicationEvent.const_140:
               setErrorContextFlag(2,0);
               trackLoginStep(HabboLoginTrackingStep.const_140);
               break;
      ...
      {
         var_52 = param2 as IRoomWidgetFactory;
         Component(var_52).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,onWidgetTrackingEvent);
         Component(var_52).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,onWidgetTrackingEvent);
         Component(var_52).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,onWidgetTrackingEvent);
         Component(var_52).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,onWidgetTrackingEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_210 != null)
            {
               var_210.connection = param1;
            }
            if(var_211 != null)
            {
               var_211.communication = _communication;
               var_211.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_286:
      ...
      {
         var_160 = IHabboConfigurationManager(param2);
         if(var_160)
         {
            Component(var_160).events.addEventListener(HabboConfigurationEvent.const_144,onConfigurationLoaded);
            if(var_211 != null)
            {
               var_211.configuration = var_160;
            }
            if(var_210 != null)
            {
               var_210.configuration = var_160;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_472.events.addEventListener(AdEvent.const_414,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1895)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1265);
            var_1895 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_840,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_507,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_679,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_200,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_140,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_154,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_173,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_678,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_43,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_352,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_353:
               var_1174.registerWarning(LagWarningLogger.const_923);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_803)
            {
               var_803.release(new IIDHabboWindowManager());
               var_803 = null;
            }
            if(var_472)
            {
               var_472.release(new IIDHabboAdManager());
               var_472 = null;
            }
            if(_navigator)
            {
            ...
            if(var_161)
            {
               if(true)
               {
                  Component(var_161).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_161).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_161).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_161).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_161).events.removeEventListener(HabboFriendListTrackingEvent.const_286,onFriendlistTrackingEvent);
               }
               var_161.release(new IIDHabboFriendList());
               var_161 = null;
            }
            if(var_386)
            {
               if(true)
               {
                  var_386.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_386.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_386.release(new IIDHabboHelp());
               var_386 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_353,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_144);
         if(var_160)
         {
            Component(var_160).events.removeEventListener(HabboConfigurationEvent.const_144,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_72);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_72,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_386 = param2 as IHabboHelp;
         var_386.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_386.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_823);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_823,onCoreRunning);
         }
      }
      ...
      {
         var_803 = IHabboWindowManager(param2);
         if(var_803)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_969 > -1 && _loc2_ < var_969)
         {
            ++var_1425;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1425);
         }
         if(var_969 > -1 && _loc2_ - var_969 > 15000)
         {
            ++var_1426;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1426);
         }
         var_969 = _loc2_;
         if(var_210 != null)
         {
            var_210.update(param1);
         }
         if(var_211 != null)
         {
            var_211.update(param1);
         }
         if(var_1174 != null)
         {
            var_1174.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_160 != null && Boolean(var_160.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_353,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_231,onRoomAdClick);
      }
      ...
      {
         var_161 = param2 as IHabboFriendList;
         Component(var_161).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_161).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_161).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_161).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_161).events.addEventListener(HabboFriendListTrackingEvent.const_286,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_1894)
         {
            var_1894 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1217,new Date().getTime().toString());
            if(var_160)
            {
               if(var_160.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_160.getKey("client.fatal.error.url");
                  ...
                  if(var_210 != null)
                  {
                     _loc4_["null"] = var_210.flashVersion;
                     _loc4_["null"] = var_210.averageUpdateInterval;
                  }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_72,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_678)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1310);
         }
         else if(param1.type == HabboHotelViewEvent.const_352)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1162);
         }
         else if(param1.type == HabboHotelViewEvent.const_43)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1342);
         }
      }
   }
}
