   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_122,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_91,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_119,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_129,onPetInfo);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_122,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_91,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_119,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_129,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_569);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_287);
                  if(param1.category == RoomObjectCategoryEnum.const_13)
                  {
                     _loc23_ = _container.sessionDataManager.getFloorItemData(_loc22_);
                  }
                  else if(param1.category == RoomObjectCategoryEnum.const_12)
                  {
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_788);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_968);
               _loc6_.expiration = _loc9_ - (getTimer() - _loc10_) / 60000;
               _loc6_.isWallItem = param1.category == RoomObjectCategoryEnum.const_12;
            ...
            case RoomObjectCategoryEnum.const_19:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_348)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_845)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_538);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_182)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_194)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_514);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1303;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_902;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_800;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1151);
               }
               else
               {
               ...
               _loc18_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_33);
               if(_loc18_ != null)
               {
                  _loc18_.setDirection(AvatarSetType.const_21,4);
                  _loc13_.image = _loc18_.getImage(AvatarSetType.const_21);
               }
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_33);
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_21,4);
               _loc4_ = _loc5_.getImage(AvatarSetType.const_21);
            }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_543.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_33);
            var_543.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc6_,_loc7_,_loc3_.name,_loc2_.petId,_loc5_.getCroppedImage(AvatarSetType.const_21),_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_19);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_514);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_104];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_273);
         _loc1_.push(RoomWidgetUserActionMessage.const_504);
         _loc1_.push(RoomWidgetUserActionMessage.const_686);
         _loc1_.push(RoomWidgetUserActionMessage.const_640);
         _loc1_.push(RoomWidgetUserActionMessage.const_619);
         _loc1_.push(RoomWidgetUserActionMessage.const_622);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_239);
         _loc1_.push(RoomWidgetFurniActionMessage.const_511);
         _loc1_.push(RoomWidgetFurniActionMessage.const_703);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_713);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_588);
         _loc1_.push(RoomWidgetUserActionMessage.const_344);
         _loc1_.push(RoomWidgetUserActionMessage.const_714);
         _loc1_.push(RoomWidgetUserActionMessage.const_527);
         _loc1_.push(RoomWidgetUserActionMessage.const_1204);
         _loc1_.push(RoomWidgetPetCommandMessage.const_662);
         _loc1_.push(RoomWidgetPetCommandMessage.const_566);
         _loc1_.push(RoomWidgetUserActionMessage.const_687);
         _loc1_.push(RoomWidgetUserActionMessage.const_426);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_104:
      ...
      public function dispose() : void
      {
         ...
         if(var_543 != null)
         {
            _loc1_ = var_543.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_543.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_273:
            ...
            case RoomWidgetUserActionMessage.const_504:
               ...
               break;
            case RoomWidgetUserActionMessage.const_686:
            ...
            case RoomWidgetUserActionMessage.const_640:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_961,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_619:
               ...
               break;
            case RoomWidgetUserActionMessage.const_622:
            ...
            case RoomWidgetRoomTagSearchMessage.const_713:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_588:
            ...
            case RoomWidgetUserActionMessage.const_344:
               ...
               break;
            case RoomWidgetUserActionMessage.const_714:
