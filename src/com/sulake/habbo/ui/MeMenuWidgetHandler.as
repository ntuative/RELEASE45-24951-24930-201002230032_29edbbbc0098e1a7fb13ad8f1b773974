   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_28,3);
               _loc2_ = _loc5_.getCroppedImage(AvatarSetType.const_28);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_176 + " " + _loc6_);
            if(var_176 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_988,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_176.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_675,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_391,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_675,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_152,onCreditBalance);
         }
         var_8 = _container.inventory;
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_878,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_634,onHabboClubSubscriptionChanged);
         }
         var_176 = _container.toolbar;
         if(var_176)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_391,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_83:
               ...
               break;
            case HabboHelpTutorialEvent.const_391:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_340));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_635);
         _loc1_.push(RoomWidgetDanceMessage.const_516);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_631);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_493);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_578);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_533);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_521);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_704);
         _loc1_.push(RoomWidgetStopEffectMessage.const_618);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1331);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_974);
         _loc1_.push(RoomWidgetToolbarMessage.const_607);
         _loc1_.push(RoomWidgetToolbarMessage.const_614);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_601);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1361);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_982);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_547);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_489);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_650);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_529);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1328);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_506);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_663);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_541);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_635:
               ...
               break;
            case RoomWidgetDanceMessage.const_516:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_631:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_493:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_578:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_704:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_80 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.CATALOG_CLUB)
               {
                  var_80.openCatalogPage(CatalogPageName.const_289,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_521:
               ...
               if(var_8 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_941:
                        var_80.openCatalogPage(CatalogPageName.const_1256,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_816:
                        var_8.toggleInventoryPage(InventoryCategory.const_249);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1291:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_533:
            case RoomWidgetStopEffectMessage.const_618:
            ...
            case RoomWidgetNavigateToRoomMessage.const_974:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_547:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_607:
               ...
               if(var_176)
               {
                  var_176.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                  ...
                  if(var_80 != null && var_80.getPurse() != null)
                  {
                     _container.events.dispatchEvent(new RoomWidgetCreditBalanceUpdateEvent(var_80.getPurse().credits));
                  }
               }
               ...
               break;
            case RoomWidgetToolbarMessage.const_614:
               ...
               if(var_176 && false)
               {
                  var_176.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_365,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_601:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_407,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_945));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_407,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1277));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_522));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_650:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_529:
