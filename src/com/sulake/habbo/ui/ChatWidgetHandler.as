package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_876:Number = 0;
      
      private var var_498:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_118];
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_499.length)
            {
               _loc2_ = var_499.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_118:
               _loc3_ = param1 as RoomSessionChatEvent;
               if(_loc3_ != null)
               {
                  _loc4_ = _container.roomEngine.getRoomObject(_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.userId,RoomObjectCategoryEnum.const_19);
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_499.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_708.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_302:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_82);
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_21).clone();
                                          _loc17_ = _loc16_.getPartColor("pbd");
                                       }
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_82);
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_28).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_499.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_708.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
                        ...
                        _loc14_ = "null";
                        _loc2_ = new RoomWidgetChatUpdateEvent(_loc14_,_loc3_.userId,_loc3_.text,_loc11_,RoomObjectCategoryEnum.const_19,_loc6_,_loc7_,_loc13_,_loc12_,_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.chatType);
                     }
                  }
               }
         }
      ...
      {
         return [RoomWidgetChatMessage.const_573,RoomWidgetChatSelectAvatarMessage.const_637];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_573:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_118,_container.roomSession,0,"Version 24951-24930-201002222356");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_876 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_876);
            }
            if(var_498 == null)
            {
               var_500.x = 0;
               var_500.y = 0;
               var_500.z = 0;
               var_498 = _loc4_.getScreenPoint(var_500);
               var_876 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_500.x = 0;
            var_500.y = 0;
            var_500.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_500);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_498.x || _loc8_.y != var_498.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_498,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_315;
      }
