package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_404:
               _loc2_ = param1 as RoomSessionDimmerPresetsEvent;
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_484);
            ...
            case RoomEngineDimmerStateEvent.DIMMER_STATE:
               ...
               _loc5_ = new RoomWidgetDimmerStateUpdateEvent(_loc4_.state,_loc4_.method_1,_loc4_.effectId,_loc4_.color,_loc4_.brightness);
               _container.events.dispatchEvent(_loc5_);
               break;
            case RoomEngineObjectEvent.const_74:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_859));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_524,RoomWidgetDimmerSavePresetMessage.const_611,RoomWidgetDimmerChangeStateMessage.const_605,RoomWidgetDimmerPreviewMessage.const_593];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_524:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerGetPresetsMessage();
               }
               break;
            case RoomWidgetDimmerSavePresetMessage.const_611:
               if(validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_605:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_593:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_404);
         _loc1_.push(RoomEngineDimmerStateEvent.DIMMER_STATE);
         _loc1_.push(RoomEngineObjectEvent.const_74);
         return _loc1_;
      }
