package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_21:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_8 = param1;
         var_21 = var_8.communication;
         var_21.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_21.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_21.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_21.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_21.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_21.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_21.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_21.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_21.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_21.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_21.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_21.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_21.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_21.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_21.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_21.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_21.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_21.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_21.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_21.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_21.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_21.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_21.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_21.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_21.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_21.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_21.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_21.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_21.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_21.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_21.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_21.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_21.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_21.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_21.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_21.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_21.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_21.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_54,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_666);
         _loc2_.refreshViews();
         var_8.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_139)
            {
            ...
            if(_loc9_.itemType == "S")
            {
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_24,_loc9_.category,_loc9_.stuffData);
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_25,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_21.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_150);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_8.setInventoryCategoryInit(InventoryCategory.const_288);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_54);
         ...
         _loc4_.updateLocks();
         if(_loc4_.getSelectedItemIndex(FurniModel.const_24) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_24,0);
         }
         if(_loc4_.getSelectedItemIndex(FurniModel.const_25) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_25,0);
         }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_8.toggleInventorySubPage(InventorySubCategory.const_222);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_8.setInventoryCategoryInit(InventoryCategory.const_249);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_437);
         var _loc4_:FurniModel = var_8.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
