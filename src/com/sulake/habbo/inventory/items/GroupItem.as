package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2246:BitmapData;
      
      protected var var_888:Boolean;
      ...
      protected var var_347:BitmapData;
      
      private const const_1397:Number = 0.2;
      
      protected var var_1327:Boolean;
      
      private const const_1398:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_654)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(_mainCategory == FurniModel.const_24)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1377));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1338);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1397;
               _loc1_.blend = const_1397;
            }
            else
            {
               _window.blend = const_1398;
               _loc1_.blend = const_1398;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1327 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2246;
               _loc5_.visible = true;
            }
            else
            {
