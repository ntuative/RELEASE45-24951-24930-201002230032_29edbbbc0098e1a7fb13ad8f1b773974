package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_763:uint = 4284532064;
      
      private static const const_762:uint = 2577770;
      ...
      private var var_343:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_343 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_20.state)
                  {
                     case TradingModel.const_149:
                        if(var_20.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_891);
                        }
                        if(false)
                        {
                           var_20.requestUnacceptTrading();
                        }
                        else
                        {
                           var_20.requestAcceptTrading();
                        }
                        break;
                     case TradingModel.const_257:
                        param2.disable();
                        var_20.requestConfirmAcceptTrading();
                  }
                  break;
               case "button_cancel":
                  switch(var_20.state)
                  {
                     case TradingModel.const_149:
                        var_20.requestCancelTrading();
                        break;
                     case TradingModel.const_257:
                        var_20.requestConfirmDeclineTrading();
                  }
            }
         }
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_20.requestRemoveItemFromTrading(param2.id);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            _loc3_ = var_20.ownUserItems.getWithIndex(param2.id);
            if(!_loc3_)
            {
               return;
            }
            _loc4_ = _loc3_.peek();
            _loc5_ = var_20.getItemImage(_loc4_);
            _loc6_ = "${roomItem.name." + _loc4_.type + "}";
            if(_loc4_.category == FurniCategory.const_139)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_866)
            {
            ...
            var_343.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_375);
            var_343.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_56.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_56.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc6_)
         {
            updateItemList(var_20.ownUserId);
         }
         _loc5_ = var_20.otherUserItems;
         _loc6_ = false;
         _loc3_ = 0;
         while(_loc3_ < _loc5_.length)
         {
         ...
         if(_loc6_)
         {
            updateItemList(var_20.otherUserId);
         }
      }
      ...
      private function othersThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_20.otherUserItems.getWithIndex(param2.id);
            if(_loc3_ == null)
            {
               return;
            }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_169)
            {
               var_169.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_169.stop();
               var_169 = null;
            }
            if(var_343 != null)
      ...
      {
         return var_56.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateItemList(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         var _loc9_:* = param1 == var_20.otherUserId;
         var _loc10_:Map = !!_loc9_ ? var_20.otherUserItems : var_20.ownUserItems;
      ...
      {
         var _loc2_:ITextWindow = var_56.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_56.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(var_56 == null)
         {
            var_56 = createNormalWindow();
         }
         if(var_1549 == null)
         {
            var_1549 = createMinimizedWindow();
         }
         if(!var_2220)
         {
            return var_56;
      ...
      {
         var _loc2_:ITextWindow = var_56.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_20.ownUserItems.length)
         {
            _loc2_ = var_20.ownUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_20.getFurniInventoryModel().displayItemInfo(_loc2_);
            }
         }
      }
      ...
      private function createNormalWindow() : IWindowContainer
      {
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_11,ownThumbEventProc);
            _loc6_++;
         }
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_11,othersThumbEventProc);
            _loc6_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_20.otherUserItems.length)
         {
            _loc2_ = var_20.otherUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_20.getFurniInventoryModel().displayItemInfo(_loc2_);
      ...
      {
         var _loc1_:ITextWindow = var_56.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_56.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function startConfirmCountdown() : void
      {
         if(var_169 == null)
         {
            var_169 = new Timer(1000,3);
            var_169.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_169.reset();
         var_169.repeatCount = 3;
         var_169.start();
      ...
      {
         var _loc1_:ITextWindow = var_56.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_56.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_56.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_20.otherUserName;
            }
            _loc1_ = var_56.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_763) : uint(const_762);
            }
            _loc3_ = var_56.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_56.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_763) : uint(const_762);
            }
            _loc3_ = var_56.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_56.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_56)
         {
            _loc1_ = var_56.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
            switch(var_20.state)
            {
               case TradingModel.const_156:
                  if(var_20.otherUserItems.length > 0 || var_20.ownUserItems.length > 0)
                  {
                     _loc1_.enable();
                  }
                  else
