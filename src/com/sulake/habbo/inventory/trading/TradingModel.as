package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_149:uint = 1;
      
      public static const const_156:uint = 0;
      
      public static const const_1206:uint = 9;
      
      public static const const_192:uint = 5;
      ...
      private var var_40:TradingView;
      ...
      private var var_698:Boolean = false;
      ...
      public function TradingModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager)
      {
         ...
         var_40 = new TradingView(this,param2,param4,param5,param6);
      }
      ...
      {
         var_40.updateItemImage(param1,param2);
      }
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_491 = false;
         var_698 = false;
         var_40.updateItemList(var_697);
         var_40.updateItemList(var_1276);
         var_40.updateUserInterface();
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_40.alertPopup(TradingView.const_930);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_697)
            {
               var_491 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_698 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_40.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_697)
            {
               var_40.alertPopup(TradingView.const_835);
            }
            close();
         }
         ...
         {
            var_40.showOtherUserNotification("${inventory.trading.warning.others_account_disabled}");
         }
         else if(param1 is TradingYouAreNotAllowedEvent)
         {
            var_40.showOwnUserNotification("${inventory.trading.warning.own_account_disabled}");
         }
         else
         {
      ...
      {
         Logger.log("OLD STATE: " + var_31 + " NEW STATE: " + param1 + " OWN: " + var_491 + " OTHER: " + var_698);
         ...
         {
            case const_156:
               if(param1 == const_149 || param1 == const_192)
               {
                  var_31 = param1;
                  _loc2_ = true;
               }
      ...
      {
         return var_40.getWindowContainer();
      }
      ...
      {
         var_40.setMinimized(param1 != InventoryCategory.const_54);
         var_8.updateSubView();
      }
      
      public function startConfirmCountdown() : void
      {
         var_40.startConfirmCountdown();
      }
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         var_551 = true;
         state = const_149;
         var_40.setup(param1,param3,param4,param6);
         var_40.updateItemList(var_697);
         var_40.updateItemList(var_1276);
         var_40.updateUserInterface();
         var_40.clearItemLists();
         var_8.toggleInventoryPage(InventoryCategory.const_54);
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_139)
            {
      ...
      public function close() : void
      {
         if(var_551)
         {
            if(var_31 != const_156 && var_31 != const_192)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_156;
            var_8.toggleInventorySubPage(InventorySubCategory.const_978);
            var_551 = false;
         }
         var_40.setMinimized(false);
      }
