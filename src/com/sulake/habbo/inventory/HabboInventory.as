package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1601:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_39.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_39.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_17 != null)
         {
            var_17.events.removeEventListener(RoomSessionEvent.const_75,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_421,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_39.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_85:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_421:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_39.getValue(InventoryCategory.const_666));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_39.getValue(InventoryCategory.const_54));
      }
      ...
      {
         var_184.clubPeriods = param1;
         var_184.clubDays = param2;
         var_184.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_878));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_39.getValue(InventoryCategory.const_150));
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_39.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:IInventoryModel = var_39.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1601);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_39.getValue(InventoryCategory.const_288));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_795.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_795.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = var_39.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_39.length)
         {
            _loc3_ = var_39.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_222:
               _view.toggleCategoryView(InventoryCategory.const_54,false);
         }
      }
      
      public function get pixelBalance() : int
      {
         return var_184.pixelBalance;
      }
      ...
      {
         return TradingModel(var_39.getValue(InventorySubCategory.const_222));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_514 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_795.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_184.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_39.getValue(InventoryCategory.const_437) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1416 = new IncomingMessages(this);
      ...
      {
         return var_184.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_184.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_39.getValue(InventoryCategory.const_249));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_75,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_421,roomSessionEventHandler);
         ...
         var_39.add(InventoryCategory.const_437,_loc3_);
         ...
         var_39.add(InventoryCategory.const_54,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_514);
         var_39.add(InventoryCategory.const_249,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_39.add(InventoryCategory.const_666,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_514);
         var_39.add(InventoryCategory.const_288,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_39.add(InventorySubCategory.const_222,_loc8_);
         var _loc9_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_39.add(InventorySubCategory.RECYCLER,_loc9_);
         ...
         var_39.add(InventoryCategory.const_150,_loc10_);
