package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1035:int = 100;
      
      public static const const_278:String = "pets";
      
      public static const const_25:String = "wall";
      
      public static const const_24:String = "floor";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_203,onObjectPlaced);
         var_439 = new Timer(const_1035,1);
         var_439.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
         ...
         _view.switchCategory(const_24);
      }
      
      public function get isTradingOpen() : Boolean
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_222;
      }
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc8_:int = 0;
         var _loc6_:Array = [const_24,const_25];
         var _loc7_:int = 0;
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_365.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_365.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_654)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_203,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_439 != null)
            {
               var_439.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_439.stop();
               var_439 = null;
            }
            if(var_120 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_139)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_285)
         {
         ...
         if(var_628 == null)
         {
            var_628 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_628.clone() as IWindowContainer;
      ...
      public function removeAllLocks() : void
      {
         ...
         var _loc3_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_24,const_25];
         var _loc6_:int = 0;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_222:
               ...
               break;
            case InventorySubCategory.const_978:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_437);
      ...
      {
         if(param1 == InventoryCategory.const_54 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_25:
                  ...
                  break;
               case const_278:
                  _controller.toggleInventoryPage(InventoryCategory.const_150);
            }
         }
      }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = getCategoryContent(const_25);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc8_:Array = [const_24,const_25];
         var _loc9_:int = 0;
      ...
      {
         if(var_752 && param1.type == RoomEngineObjectEvent.const_203)
         {
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_24,const_25];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
      ...
      public function removeFurni(param1:int) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         var _loc7_:Array = [const_24,const_25];
         var _loc8_:int = 0;
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_309 || _loc3_.category == FurniCategory.const_292 || _loc3_.category == FurniCategory.const_285)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_365.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_365 = new Map();
         var_365.add(const_24,new Array());
         var_365.add(const_25,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
