package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_681:MarketplaceModel;
      
      private var var_490:Map;
      
      private var var_489:String;
      
      private const const_1623:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_490 = new Map();
         var_490.add(FurniModel.const_24,new FurniGridView(_model,FurniModel.const_24,_windowManager,_assetLibrary,_roomEngine));
         var_490.add(FurniModel.const_25,new FurniGridView(_model,FurniModel.const_25,_windowManager,_assetLibrary,_roomEngine));
         ...
         switchCategory(FurniModel.const_24);
         ...
         else if(param1.type == WindowEvent.const_36)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  switchCategory(FurniModel.const_25);
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_278);
            }
         }
      }
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_24,FurniModel.const_25];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_285)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_139)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_681 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
