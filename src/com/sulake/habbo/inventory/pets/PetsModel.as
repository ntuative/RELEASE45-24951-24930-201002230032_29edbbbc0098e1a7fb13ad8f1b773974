package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_150 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1249 && param1.type == RoomEngineObjectEvent.const_203)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1249 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_19,RoomObjectTypeEnum.const_302,_loc3_.figure);
      ...
      {
         if(var_901.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
