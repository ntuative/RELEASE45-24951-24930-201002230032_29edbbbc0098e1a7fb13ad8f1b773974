package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_275:PetsGridItem;
      ...
      private var var_479:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_479 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_532 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_532.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_275 != null)
         {
            var_275.setSelected(false);
         }
         var_275 = param1;
         if(var_275 != null)
         {
            var_275.setSelected(true);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_36)
         {
            ...
            {
               case "tab_floor":
                  _model.switchCategory(FurniModel.const_24);
                  break;
               case "tab_wall":
                  _model.switchCategory(FurniModel.const_25);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_275.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_532.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_479.removeGridItem(_loc2_.window);
         if(var_275 == _loc2_)
         {
            var_275 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_532.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_479.addGridItem(_loc2_.window);
            var_532.add(param1.id,_loc2_);
            if(var_275 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImage(_loc12_.figure,AvatarScaleType.const_33);
            if(_loc13_ == null)
            {
               return;
            }
            _loc13_.setDirection(AvatarSetType.const_21,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_21);
            _loc3_ = _loc12_.name;
