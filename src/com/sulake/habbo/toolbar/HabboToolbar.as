package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_558.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_92,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_988,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_158,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_143,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_29,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_365,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_636,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_955,onHideWindowEvent);
         var_31 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_63));
      }
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_31 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_29)
            {
