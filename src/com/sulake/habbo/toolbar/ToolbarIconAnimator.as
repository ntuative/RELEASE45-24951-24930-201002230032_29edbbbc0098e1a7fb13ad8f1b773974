package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_759 = new Array();
         var_31 = param1.id;
         var_1301 = param1.nextState;
         var_1127 = param1.loop;
         if(param1.background != null)
         {
            var_758 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_760.push(new XML());
               var_759.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_759[var_46] = param6.clone();
         }
      ...
      {
         if(var_1127 == true || var_630 == 0)
         {
            if(false)
            {
               ++var_46;
               if(var_46 >= var_760.length)
               {
                  var_46 = 0;
                  ++var_630;
               }
      ...
      {
         return var_760.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1127 == false && var_630 == 1 && var_1301 != var_31;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_758 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_758.width),Math.max(param2.height,var_758.height));
            _loc3_.copyPixels(var_758,var_758.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_46 <= var_759.length)
         {
            _loc2_ = var_759[var_46];
