package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1073:Number = 90;
      
      private static const const_737:int = 50;
      
      private static const const_1059:Number = 25;
      
      private static const const_1060:int = 50;
      
      private static const const_162:Boolean = true;
       
      
      private var var_538:Timer;
      
      private var var_949:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_949 = param2;
         var_538 = new Timer(const_1059);
         var_538.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_461.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_461.splice(_loc3_,1);
            var_460.splice(_loc3_,1);
         }
         var_460.push(param1.name);
         var_461.push(param2);
         param1.addEventListener(WindowEvent.const_384,windowEventListener);
         param1.addEventListener(WindowEvent.const_171,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_461[var_460.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_949.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_280.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_280.splice(var_280.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_949.getIconLoc(param1.iconId);
      ...
      {
         return var_460[var_461.indexOf(param1)];
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < var_280.length)
         {
            repositionWindow(var_280[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_537[_loc3_] = new Array();
            }
            if(var_537[_loc3_].indexOf(param1) < 0)
            {
               var_537[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_737 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_737 || param1.desktop.height - param1.y < const_1060;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_460.length)
         {
            if(var_460[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_537[_loc3_].length)
                  {
                     repositionWindow(var_537[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
