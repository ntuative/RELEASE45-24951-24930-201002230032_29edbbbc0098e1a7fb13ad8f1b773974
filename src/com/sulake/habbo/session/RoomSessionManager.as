package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_277,_loc7_));
         return true;
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1155)
         {
            gotoRoom(var_1848,var_1850,var_1156);
            var_1155 = false;
            var_1156 = "";
         }
      }
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 != null && var_77 != null)
         {
            _loc2_ = 0;
            while(_loc2_ < var_77.length)
            {
               _loc3_ = var_77[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
      ...
      private function createHandlers() : void
      {
         ...
         var_77.push(new RoomSessionHandler(_connection,this));
         var_77.push(new RoomChatHandler(_connection,this));
         var_77.push(new RoomUsersHandler(_connection,this));
         var_77.push(new RoomPermissionsHandler(_connection,this));
         var_77.push(new AvatarEffectsHandler(_connection,this));
         var_77.push(new RoomDataHandler(_connection,this));
         var_77.push(new PresentHandler(_connection,this));
         var_77.push(new PlaceObjectErrorHandler(_connection,this));
         var_77.push(new TeleportErrorHandler(_connection,this));
         var_77.push(new GenericErrorHandler(_connection,this));
         var_77.push(new PollHandler(_connection,this));
         var_77.push(new VoteHandler(_connection,this));
         var_77.push(new LidoHandler(_connection,this));
         var_77.push(new RoomDimmerPresetsHandler(_connection,this));
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < var_77.length)
            {
               _loc4_ = var_77[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_85,_loc4_));
            _loc4_.dispose();
         }
      }
