package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_952:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_277 && _connection != null)
         {
            var_31 = RoomSessionEvent.const_75;
            if(isPrivateRoom)
            {
      ...
      {
         return var_952 as IUserDataManager;
      }
