package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1129:String = "normal_badge";
      ...
      private const const_1388:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1388,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1388 + param1;
         ...
         switch(param2)
         {
            case const_1129:
               if(var_160 != null)
               {
                  _loc5_ = var_160.getKey("image.library.url","http://images.habbohotel.com/c_images/");
            ...
            case const_908:
               if(var_160 != null)
               {
                  if(var_160 != null)
                  {
                     _loc5_ = var_160.getKey("group.badge.url");
         ...
         if(_loc4_ != null)
         {
            ...
            _loc8_.addEventListener(AssetLoaderEvent.const_14,onBadgeImageReady);
         }
