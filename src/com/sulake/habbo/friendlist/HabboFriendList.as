package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_148:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_1776:IAvatarRenderManager;
      
      private var var_1535:AvatarSearchResults;
      
      private var var_115:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_873:FriendRequests;
      
      private var var_2199:int;
      
      var var_309:FriendCategories;
      
      private var var_176:IHabboToolbar;
      
      private var var_2200:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_395:FriendListTabs;
      
      private var var_2198:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1536:OpenedToWebPopup;
      ...
      {
         var_2200 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_309 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1535 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1536 == null)
         {
            var_1536 = new OpenedToWebPopup(this);
         }
         var_1536.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_873.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_873.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_395.findTab(FriendListTab.const_79).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_143,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_873.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_176.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_115 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_309.findFriend(param1);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = _windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_23,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_873 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_309.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_309.addCategory(new FriendCategory(FriendCategory.const_975,getText("friendlist.friends")));
         var_309.addCategory(new FriendCategory(FriendCategory.const_429,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_309.addFriend(new Friend(_loc4_));
         }
         var_395 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_176.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_309.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_66);
      ...
      {
         var _loc2_:IAvatarImage = var_1776.createAvatarImage(param1,AvatarScaleType.const_82);
         return _loc2_.getCroppedImage(AvatarSetType.const_28);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1776 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_873.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_395.findTab(FriendListTab.const_79);
      ...
      {
         var_2198 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_309.getFriendCount(param1,param2);
      }
      ...
      {
         var _loc1_:String = var_160.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_395.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_286));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_66:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_306:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH);
                     break;
                  case FriendListTab.const_79:
      ...
      {
         var_176 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         return var_160.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1535.searchReceived(_loc2_.friends,_loc2_.others);
