package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_825;
      ...
      public function getCountOfOpenRequests() : int
      {
         ...
         {
            if(_loc2_.state == FriendRequest.const_117)
            {
               _loc1_++;
            }
         }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc3_ in var_480)
         {
            if(!param1 || _loc3_.state != FriendRequest.const_117)
            {
               _loc2_.push(_loc3_);
            }
         }
