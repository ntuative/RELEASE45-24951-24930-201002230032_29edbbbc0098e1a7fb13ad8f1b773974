package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_339.shockwaveClientUrl = var_110.shockwaveClientUrl;
         var_339.ssoTicket = var_110.ticket;
         var_110.removeEventListener(SSOTicket.const_310,onParsedTicketSuccess);
         var_110.removeEventListener(SSOTicket.const_219,onParsedTicketFailure);
         var_110 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1389,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_339.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_388,HabboWindowStyle.const_23,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_78,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1389,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_110 = new SSOTicket(var_339.assets,_loc2_,_loc1_);
         var_110.addEventListener(SSOTicket.const_310,onParsedTicketSuccess);
         var_110.addEventListener(SSOTicket.const_219,onParsedTicketFailure);
      }
