package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_154:HabboHotelView;
      ...
      private var var_1728:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1378:ILogger;
      
      private var var_1116:String;
      
      private var var_1729:String;
      
      private const const_1389:String = "fuselogin";
      
      private var var_558:ICoreCommunicationManager;
      
      private var var_440:IKeyExchange;
      ...
      private var var_61:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_929)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_154);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_314:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_914:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_937:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_970:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1730)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_629 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_629);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_140);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1116,var_1729));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1389,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_440.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_440.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1728);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1389,"/");
      ...
      {
         var_629 = _habboConfiguration.getKey("sso.ticket",null);
         var_1116 = _habboConfiguration.getKey("flash.client.url","");
         var_1729 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_154 == null)
         {
            var_154 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_629 != null)
         {
            var_61.mode = HabboConnectionType.const_382;
            var_61.initConnection(HabboConnectionType.const_220);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1378 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_61 = param2 as IHabboCommunicationManager;
            _loc3_ = var_61.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_61.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_61.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_61.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_61.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_61.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_61.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_61.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_61.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_61.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_61.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_61.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_61.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_61.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_679);
            _loc3_ = new InitCryptoMessageComposer(var_61.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1728 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_61.mode)
         {
            case HabboConnectionType.const_382:
               ...
               var_928 = _loc4_;
               var_154.loadBannerImage(_loc7_ + "?token=" + var_928,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1116:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1230:
               var_930 = generateRandomHexString(30);
               var_440 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_440.init(var_930);
               _loc8_ = var_440.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_154.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_928);
         ...
         var _loc9_:IConnection = var_61.getHabboMainConnection(null);
         ...
         var_440 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_930 = generateRandomHexString(30);
            var_440.init(var_930);
            _loc12_ = var_440.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_173);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_144,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_85,onRoomSessionEnded);
      }
