package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1385:int = 5;
      
      private static const const_479:int = 16;
      
      private static const const_1023:int = 20;
      
      private static const const_330:int = 10;
      
      private static const const_1024:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_917 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1640 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1638 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_610 = new Timer(1000,1);
         var_610.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_734 = new Timer(5000,1);
         var_734.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_37,HabboWindowStyle.const_23,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_133,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_26,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_121,onInputChanged);
         _window.addEventListener(WindowEvent.const_384,onWindowMoved);
         var_1095 = true;
         var_116 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1639 = _loc2_.width + const_479 + _loc6_.width + const_1023;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1024,_loc8_.width) + const_479);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_917 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_116 = "";
               }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_34,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_434);
