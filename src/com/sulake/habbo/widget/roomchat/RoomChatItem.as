package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_479:int = 6;
      
      private static const const_330:int = 10;
      
      private static const const_1108:Number = 18;
      
      private static const const_1410:Number = 10;
      
      private static const const_1409:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1044,var_1043,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1044,var_1043,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1308 = param1.chatType;
         var_1044 = param1.userId;
         var_875 = param1.userName;
         var_1043 = param1.userCategory;
         _message = param1.text;
         var_1307 = param1.userX;
         var_194 = param1.userImage;
         var_1042 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_74,_y,width,_height);
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            param1.setParamFlag(HabboWindowParam.const_22,true);
            param1.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onBubbleMouseClick);
            param1.addEventListener(WindowMouseEvent.const_34,onBubbleMouseDown);
            param1.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,onBubbleMouseOver);
            param1.addEventListener(WindowMouseEvent.const_11,onBubbleMouseOut);
            param1.addEventListener(WindowMouseEvent.const_78,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1308)
         {
            case RoomWidgetChatUpdateEvent.const_100:
               _loc1_ = "bubble_speak";
               break;
            case RoomWidgetChatUpdateEvent.const_99:
               _loc1_ = "bubble_whisper";
               break;
            case RoomWidgetChatUpdateEvent.const_84:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_218:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_241:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_194 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_194.height);
         }
         ...
         var_90 = _window as IRegionWindow;
         var_90.background = true;
         var_90.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_90);
         ...
         if(var_194 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_194.width;
               _loc28_.height = var_194.height;
               _loc28_.bitmap = new BitmapData(var_194.width,var_194.height,true,0);
               _loc28_.bitmap.copyPixels(var_194,var_194.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_410 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_194.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1042 != 0)
            {
               _loc30_ = uint(var_1042 >> 16 & 255);
               _loc31_ = uint(var_1042 >> 8 & 255);
               _loc32_ = uint(var_1042 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_330;
            }
            else
            {
               _loc19_.text = var_875 + ":";
               _loc19_.y += var_410;
               _loc19_.width = _loc19_.textWidth + const_330;
               _width += _loc19_.textWidth + const_330;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1308 == RoomWidgetChatUpdateEvent.const_218)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_875);
            }
            else if(var_1308 == RoomWidgetChatUpdateEvent.const_241)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_875);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_410;
            _loc20_.width = _loc20_.textWidth + const_479;
            _width += _loc20_.textWidth + const_479;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_330 + _loc20_.textWidth + const_479;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1044,var_1043,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1044,var_1043,_roomId,_roomCategory,param1);
      }
