   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_790 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_158.duration);
               var_790.width = _loc2_ * var_391;
            }
            else
            {
               var_790.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               _window.addEventListener(WindowMouseEvent.const_11,onMouseEvent);
            }
            if(false)
            {
            ...
            var_791 = _window.findChildByName("effect_hilite");
            var_791.visible = false;
         }
         var_789 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_790 = _window.findChildByName("loader_bar");
         if(var_790 != null)
         {
            var_391 = var_790.width;
            var_169.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_158.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_789 != null)
         {
            var_789.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_789.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
