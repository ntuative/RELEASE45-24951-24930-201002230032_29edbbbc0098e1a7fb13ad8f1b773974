package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_143[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_143[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_143)
         {
            _loc6_ = var_143[_loc3_];
         ...
         while(_loc5_ < _window.numChildren)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_11,onMouseOverOrOut);
            _loc5_++;
         }
      ...
      {
         var_143 = new Dictionary();
         var_143["rooms_icon"] = ["gohome_white","gohome_color"];
         var_143["dance_icon"] = ["dance_white","dance_color"];
         var_143["clothes_icon"] = ["clothes_white","clothes_color"];
         var_143["effects_icon"] = ["effects_white","effects_color"];
         var_143["badges_icon"] = ["badges_white","badges_color"];
         var_143["wave_icon"] = ["wave_white","wave_color"];
         var_143["hc_icon"] = ["_white","_color"];
         var_143["settings_icon"] = ["settings_white","settings_color"];
         var_143["credits_icon"] = ["credits_white","credits_color"];
         var_143["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_989);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_852));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_555);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_816));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_214);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.CATALOG_CLUB));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_707);
               break;
            case "news":
               if(false && false)
               {
