package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1607:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1605:String = "level";
      
      private var var_97:IItemListWindow;
      
      private const const_1609:String = "energy";
      
      private var var_1182:Map;
      
      private const const_1610:String = "nutrition";
      
      private var var_53:IItemListWindow;
      
      private const const_1604:uint = 3355443;
      
      private var var_212:IBorderWindow;
      
      private const const_1611:int = 158;
      
      private const const_1603:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_252:PetCommandTool;
      
      private const const_1606:uint = 11184810;
      
      private const const_1608:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _loc4_ = 0;
         while(_loc4_ < var_53.numListItems)
         {
            _loc9_ = var_53.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc9_ != null)
            {
         ...
         var _loc7_:* = [];
         var_53.groupListItemsWithTag("CMD_BUTTON",_loc7_,true);
         for each(_loc8_ in _loc7_)
         {
            ...
            _loc8_.addEventListener(WindowEvent.const_26,onButtonResized);
         }
      }
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_97.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_97.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_252 == null)
         {
            var_252 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1182.getValue(var_660) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_252.showWindow(true);
            var_252.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_97.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_97.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1605,param1.level,param1.levelMax);
         updateStateElement(const_1608,param1.experience,param1.experienceMax);
         updateStateElement(const_1609,param1.energy,param1.energyMax);
         updateStateElement(const_1610,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_660 = param1.id;
         var_1182.remove(param1.id);
         var_1182.add(param1.id,param1);
         if(var_252 && var_252.isVisible() && param1.isOwnPet)
         {
            var_252.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_97.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = var_53.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_252.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_376,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1611,const_1603,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1606);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1604);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1607);
         return _loc5_;
      }
