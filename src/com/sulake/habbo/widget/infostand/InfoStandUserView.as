package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_97:IItemListWindow;
      
      private var var_975:TagListRenderer;
      ...
      private var var_107:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_975 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_53 = _window.getListItemByName("button_list") as IItemListWindow;
         var _loc4_:* = [];
         var_53.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_.addEventListener(WindowEvent.const_26,onButtonResized);
         }
         if(var_212 != null)
         {
            var_97 = var_212.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < var_53.numListItems)
            {
               _loc13_ = var_53.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
         ...
         while(_loc8_ < 5)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc10_.addEventListener(WindowMouseEvent.const_11,hideBadgeInfo);
            }
            _loc8_++;
         }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_107.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_107.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_107.x = _loc5_.left - 0;
         var_107.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = var_97.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_97.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_97.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_97 == null || var_212 == null || var_53 == null)
         {
            return;
         }
         var_53.width = var_53.scrollableRegion.width;
         var_97.height = var_97.scrollableRegion.height;
         var_212.height = NaN;
         _window.width = Math.max(var_212.width,var_53.width);
      ...
      {
         var _loc2_:ITextWindow = var_97.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_97.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_97.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_97.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_975.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_97.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_97.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_97.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = var_53.getListItemByName(param1);
         if(_loc3_ != null)
         {
            _loc3_.visible = param2;
            var_53.arrangeListItems();
         }
      }
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = var_53.getListItemByName(param1) as IRegionWindow;
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_107 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_107 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = var_53.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_902:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_800:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_107.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_107.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_107.x = _loc7_.left - 0;
         var_107.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = var_97.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_97.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_182:
               var_53.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_194:
      ...
      {
         var _loc3_:IWindowContainer = var_97.getListItemByName("image_and_badges_container") as IWindowContainer;
