package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1593:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1089 != null && var_1089.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_101);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_732 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_732 += param1.height + const_1592;
            return fit(param1);
         }
         param1.offset(_offsetX,var_732);
         _offsetX += param1.width + const_1593;
         return true;
      }
