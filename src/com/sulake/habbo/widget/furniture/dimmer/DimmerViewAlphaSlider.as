package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_78 && param1.type != WindowMouseEvent.const_572)
         {
            return;
         }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_576 != null)
            {
               ...
               var_1515 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1515 * (Number(param1 - var_700) / (var_1020 - var_700)));
      }
      ...
      {
         return int(param1 / var_1515 * (var_1020 - var_700)) + var_700;
      }
   }
}
