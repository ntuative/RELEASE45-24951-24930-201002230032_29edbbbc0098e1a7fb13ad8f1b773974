package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1192:XML;
      
      private var var_382:int;
      
      private var var_473:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1924:int;
      
      private var var_320:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_221.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_221.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_37,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1004,const_1005,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_473 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_320 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_221 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_221.numTabItems)
         {
            _loc6_ = var_221.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_22,true);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_473 != null)
         {
            var_473.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_221.selector.getSelected();
         return var_221.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_320 != null)
         {
            var_320.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_981 = _loc2_.light;
         if(var_320 != null)
         {
            var_320.setValue(var_981);
         }
         var_382 = colors.indexOf(_loc2_.color);
         if(var_473 != null)
         {
            var_473.setSelectedColorIndex(var_382);
         }
