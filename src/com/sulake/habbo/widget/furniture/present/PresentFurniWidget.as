package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1005:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_40,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_357,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_419,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_335,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_94,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_40,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_40,onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_357,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_419,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_335,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_40,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_40:
               hideInterface();
               var_202 = false;
               var_138 = param1.objectId;
               var_180 = param1.text;
               _controller = param1.controller;
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_357:
               if(!var_202)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_419:
               if(!var_202)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_335:
               if(!var_202)
               {
                  return;
               }
      ...
      private function onEcotronUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_40:
               hideInterface();
         }
      }
      ...
      {
         var _loc1_:* = null;
         if(var_202 || var_138 == -1 || !_controller)
         {
            return;
         }
         var_202 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_610,var_138);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_37,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1004,const_1005,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_180 != null)
         {
            _loc4_.caption = var_180;
         }
