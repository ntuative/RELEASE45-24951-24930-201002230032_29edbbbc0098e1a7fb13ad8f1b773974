package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1093:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_543,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_110,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_88,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_543,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_110,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_88,onDoorbellHandled);
      }
