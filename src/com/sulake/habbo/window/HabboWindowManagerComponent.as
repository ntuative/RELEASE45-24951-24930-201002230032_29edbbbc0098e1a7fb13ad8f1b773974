package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_323:uint = 3;
      ...
      private var var_1196:ProfilerAgentTask;
      
      private var var_1197:IEventDispatcher;
      
      private var var_2344:uint = 0;
      
      private var var_1198:ProfilerAgentTask;
      
      private var var_1195:ProfilerOutput;
      
      private var var_664:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_188 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1197 = Component(param1).events;
            var_811 = new Array();
      ...
      {
         return var_288[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_288[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_664 = new WindowRenderer(_loc4_);
         var_288 = new Array(const_323);
         var _loc6_:int = 0;
         while(_loc6_ < const_323)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_664,this,_localization,var_188,new Rectangle(0,0,var_188.stageWidth,var_188.stageHeight),this);
            var_288[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_358 = var_288[const_1068];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_358.getMouseCursor().defineCustomCursorType(MouseCursorType.const_266,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_358.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1133,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_288[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_288.pop()).dispose();
            }
            if(_localization)
            {
      ...
      {
         return var_288[param1].getDesktopWindow().getChildAt(var_358.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1195 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1195 = new ProfilerOutput(_loc3_,this,var_664);
               var_1196 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1196);
               var_1198 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1198);
               var_988 = true;
            }
         }
      }
      ...
      {
         return var_358.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_881.length > 0)
         {
            var_1197.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_323 - 1;
            while(_loc2_ >= 0)
            {
               var_288[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_988)
         ...
         var_1197.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_323)
         {
            var_288[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_988)
         {
         ...
         if(WindowContext.var_881.length > 0)
         {
            WindowContext.var_881.flush();
         }
         if(WindowContext.var_1321.length > 0)
         {
            WindowContext.var_1321.flush();
         }
         var_1197.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_811[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_811[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_358.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1190,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1139,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1327,param2.name + ": " + param2.toString());
            }
         }
      }
   }
