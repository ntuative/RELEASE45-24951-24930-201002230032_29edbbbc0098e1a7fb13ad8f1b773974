package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_731:String = "selection_arrow";
      
      private static const const_730:String = "tile_cursor";
      
      private static const const_258:String = "RCL_PUBLICROOM_";
      
      private static const const_467:String = "wall_place_holder";
      
      private static const const_1040:int = 2;
      
      private static const const_321:String = "place_holder";
      
      private static const const_1041:String = const_321;
      
      private static const const_1392:int = 0;
      
      private static const const_729:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_600:String = "RCL_LOADER_READY";
      ...
      private var var_935:IEventDispatcher = null;
      
      private var var_1122:Map = null;
      ...
      private var var_156:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_443 = [];
         _wallItems = [];
         var_1751 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1755 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_373 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_301,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_103 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_374 != null)
         {
            _loc2_ = var_374.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_258 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(var_156 != null && var_156.hasWorldType(const_258 + param1))
         {
            return var_156.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_442.add(_loc10_,_loc11_);
                              if(var_443.indexOf(_loc14_) < 0)
                              {
                                 var_443.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_373 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_373.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_373.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_525.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_373.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_321,const_467,ROOM_CONTENT,const_730,const_731];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_13 || _loc2_ == RoomObjectCategoryEnum.const_12)
         {
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1751.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_142 && _loc5_ != RoomObjectLogicEnum.const_103)
         {
            _loc6_ = "@shadow";
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_156 != null && (var_156.type == param1 || var_156.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1041;
      ...
      {
         if(var_526.getValue(param1) != null)
         {
            return var_526.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_372 != null)
         {
            _loc2_ = var_372.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1159);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1755.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1122.add(_loc5_,_loc8_);
               var_156 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_301,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_337,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_443.indexOf(param1) >= 0)
         {
            return RoomObjectCategoryEnum.const_13;
         }
         if(_wallItems.indexOf(param1) >= 0)
         {
            return RoomObjectCategoryEnum.const_12;
         }
         if(param1.indexOf("poster") == 0)
         {
            return RoomObjectCategoryEnum.const_12;
         ...
         if(var_156 != null && (var_156.type == param1 || var_156.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_42;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_42;
         ...
         if(param1 == "user")
         {
            return RoomObjectCategoryEnum.const_19;
         }
         if(param1 == "pet")
         {
            return RoomObjectCategoryEnum.const_19;
      ...
      private function continueInitilization() : void
      {
         if(var_1752)
         {
            ...
            if(var_935 != null)
            {
               var_935.dispatchEvent(new Event(const_600));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_156 != null)
         {
            return var_156.getWorldHeightScale(const_258 + param1);
         }
         return 1;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               if(_loc3_ == RoomObjectCategoryEnum.const_13 || _loc3_ == RoomObjectCategoryEnum.const_12)
               {
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_14,furniDataLoadedHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_27,furniDataLoadedHandler);
            var_935 = param1;
            var_1756 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1754 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1750 = param2.getKey("public.room.dynamic.download.url","");
            var_1753 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_729;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_372 != null)
         {
            var_372.remove(param1);
            var_372.add(param1,param2);
         }
         if(var_374 != null)
         {
            var_374.remove(param2);
            var_374.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_142 && _loc5_ != RoomObjectVisualizationEnum.const_103)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_353.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_258 + param1) == RoomObjectCategoryEnum.const_42)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1122.getValue(param1) != null)
         {
            var_156 = var_1122.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_441,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_156 != null)
         {
            return var_156.getWorldScale(const_258 + param1);
         }
         return 32;
      }
