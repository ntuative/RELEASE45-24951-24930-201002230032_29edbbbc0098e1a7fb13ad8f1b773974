package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1393:int = 0;
      
      private var var_545:String;
      
      private var var_597:int = 0;
      
      private const const_1591:int = 1;
      ...
      private const const_1042:int = 3;
      
      private const const_1590:int = 2;
      
      private var var_731:AvatarVisualizationData = null;
      
      private const const_1022:int = 3;
      ...
      {
         var_731 = param1 as AvatarVisualizationData;
         createSprites(const_1022);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_359.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_138);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_623);
         ...
         var _loc14_:Number = _loc8_ - var_1131;
         if(_loc14_ > 5000 && _loc6_ != null && _loc6_.getScale() == AvatarScaleType.const_33)
         {
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_312);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_269 != _loc3_.getUpdateID() || var_196 != param1.scale || var_150 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_452 > 0;
         if(_loc20_ || _loc21_)
         {
            --var_452;
            _loc23_ = getTimer();
            if(var_545 != _loc7_)
            {
               for each(_loc49_ in var_359.getKeys())
               {
                  var_359.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               ...
               var_359.remove(_loc5_);
               var_359.add(_loc5_,_loc6_);
               var_545 = _loc7_;
            }
            _loc24_ = _loc3_.getDirection().x - (param1.direction.x + 135 - 22.5);
            _loc24_ = (_loc24_ % 360 + 360) % 360;
            _loc6_.setDirectionAngle(AvatarSetType.const_21,_loc24_);
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_318);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_240) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_28,_loc25_);
            _loc6_.initActionAppends();
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_240);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_632);
            _loc6_.appendAction(AvatarAction.const_627,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_333);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_33)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_339);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_300,AvatarAction.const_1358[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_811);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_895,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_927);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_785);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_801,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_538);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_693);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_981,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_772);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_938,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_435);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_464) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_599);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_415);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_838);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_643,_loc36_);
            }
            ...
            _loc37_ = _loc6_.getImage(AvatarSetType.const_21);
            if(_loc37_ == null)
            {
               return;
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_857))
            {
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_731.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_269 = _loc3_.getUpdateID();
            var_150 = _loc4_.getUpdateID();
            var_196 = param1.scale;
            var_730.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_730)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_359 != null)
         {
            _loc1_ = var_359.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_359.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
