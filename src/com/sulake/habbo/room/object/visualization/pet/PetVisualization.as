package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_848);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_911)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_812);
               var_452 = const_1042;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_240);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_269 != _loc3_.getUpdateID() || var_196 != param1.scale || var_150 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_452 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            _loc18_ = getTimer();
            --var_452;
            if(var_545 != _loc7_)
            {
               for each(_loc36_ in var_359.getKeys())
               {
                  var_359.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_21,_loc19_);
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_318);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_28,_loc20_);
            _loc6_.initActionAppends();
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_240);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_632);
            _loc6_.appendAction(AvatarAction.const_627,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_333);
            if(_loc24_ != null && _loc24_ != "")
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_339);
               _loc39_ = 3;
               _loc40_ = _loc8_ - _loc38_;
               if(_loc40_ < _loc39_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_300,_loc24_);
               }
            }
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_464) > 0;
            if(_loc25_)
            {
            ...
            _loc26_ = _loc6_.getImage(AvatarSetType.const_21);
            if(_loc26_ == null)
            {
               return;
            }
            ...
            _loc30_ = _loc6_.getSprites().length + const_1022;
            ...
            _loc31_ = getSprite(const_1590);
            if(_loc10_ > 0)
            {
               _loc29_ = null;
               _loc29_ = var_731.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_730.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_730)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
