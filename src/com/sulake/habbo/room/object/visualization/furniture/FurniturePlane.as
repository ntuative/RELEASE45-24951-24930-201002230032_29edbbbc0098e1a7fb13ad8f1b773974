package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_541 = new Vector3d();
         var_541.assign(param2);
         var_540 = new Vector3d();
         var_540.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1854)
         {
            if(!param1)
            {
               var_244.assign(var_541);
               var_245.assign(var_540);
            }
            else
            {
               var_244.assign(var_541);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_62 == null && var_740 != null || var_244 == null || var_245 == null || var_437 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1163)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_954 || _loc4_.y != var_1857 || _loc4_.z != var_1856 || param1.scale != var_1855))
            {
               var_954 = _loc4_.x;
               var_1857 = _loc4_.y;
               var_1856 = _loc4_.z;
