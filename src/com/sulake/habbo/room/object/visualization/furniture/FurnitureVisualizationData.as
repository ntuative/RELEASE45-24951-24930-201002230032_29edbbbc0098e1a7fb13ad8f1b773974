package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_485:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_485 = var_261.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_485 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_261 != null)
         {
            ...
            {
               _loc1_ = var_261.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_261.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_261.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
