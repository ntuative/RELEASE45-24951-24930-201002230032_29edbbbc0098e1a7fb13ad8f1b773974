package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1472:int = 16777216;
      
      public static const const_1490:int = 1;
       
      
      private var var_2324:int = 69069;
      
      private var var_1226:int = 1;
      
      private var var_2323:int = 5;
      
      private var var_1468:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1468 * param2);
      }
      ...
      {
         var _loc1_:int = var_2324 * var_1226 + var_2323;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
