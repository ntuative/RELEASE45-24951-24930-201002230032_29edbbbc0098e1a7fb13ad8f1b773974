package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1095:int = 16777215;
      
      public static const const_1264:int = 10066329;
      
      private static const const_1094:int = 13421772;
      
      public static const const_1292:int = 16777215;
      
      private static const const_1406:int = 0;
      
      public static const const_1270:int = 16777215;
      
      private static const const_1096:int = 10066329;
      
      private static const const_1097:int = 10066329;
      
      public static const const_1208:int = 13421772;
      ...
      private var var_570:Rectangle = null;
      
      private var var_2108:int = 255;
      
      private var var_2041:Boolean = false;
      
      private var var_2107:int = 255;
      
      private var var_2111:String = null;
      
      private const const_1618:int = 250;
      ...
      private var var_402:RoomPlaneBitmapMaskParser = null;
      
      private var var_954:Number = 0;
      ...
      public function RoomVisualization()
      {
         ...
         var_402 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_71.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_248)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_862);
         ...
         while(_loc7_ < var_71.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_124)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_170,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1292;
               }
               else
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_253,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
               ...
               {
                  _loc13_.color = const_1097;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1095;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1094;
               }
               else
               {
                  _loc13_.color = const_1096;
               }
               if(_data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_248)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_99 != null)
         {
            ...
            {
               _loc2_ = var_99[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_253 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_570 == null)
         {
            var_570 = super.boundingRectangle;
         }
         return new Rectangle(var_570.x,var_570.y,var_570.width,var_570.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_402.maskCount)
         {
            _loc6_ = var_402.getMaskType(_loc5_);
            _loc7_ = var_402.getMaskLocation(_loc5_);
            _loc8_ = var_402.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_99.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_253 || _loc3_.type == RoomPlane.const_168 && _loc8_ == RoomPlaneBitmapMaskData.const_205)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1489;
                        if(var_71.getPlaneType(_loc9_) == RoomPlaneData.const_124)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1163)
         {
            var_1163 = param1.updateId;
            var_570 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_954 || _loc9_.y != var_1857 || _loc9_.z != var_1856 || param1.scale != var_1855))
            {
               var_954 = _loc9_.x;
               var_1857 = _loc9_.y;
               var_1856 = _loc9_.z;
               var_1855 = param1.scale;
               _loc4_ = true;
            }
         }
         var _loc6_:IRoomObjectModel = _loc3_.getModel();
         initializeRoomPlanes();
         if(var_150 != _loc6_.getUpdateID())
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_932);
            if(_loc10_ != var_2111)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_606));
            if(_loc11_ != var_1016)
            {
               var_1016 = _loc11_;
               var_2107 = var_1016 & 255;
               var_2108 = var_1016 >> 8 & 255;
               var_2109 = var_1016 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1875 + const_1618 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1875 = _loc7_;
         if(var_150 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_702);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_482);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_710);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2110 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_901));
            var_150 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_401.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_401[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_168)
            {
               if(var_2110)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_2107 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2108 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2109 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_99.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_170 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_253 && param2 != null)
               {
                  _loc5_.id = param2;
               }
