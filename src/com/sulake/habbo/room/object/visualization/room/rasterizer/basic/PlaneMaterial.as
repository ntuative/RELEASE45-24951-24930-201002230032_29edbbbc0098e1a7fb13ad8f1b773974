package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterial
   {
      ...
      private function getMaterialCellMatrix(param1:IVector3d) : PlaneMaterialCellMatrix
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_474.length)
         {
            _loc3_ = var_474[_loc2_] as PlaneMaterialCellMatrix;
            if(_loc3_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_474.length)
            {
               _loc2_ = var_474[_loc1_] as PlaneMaterialCellMatrix;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
