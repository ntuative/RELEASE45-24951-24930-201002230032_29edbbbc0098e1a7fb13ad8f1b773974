package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_635:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_635 = var_377.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_635 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_377 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_377.length)
            {
               _loc1_ = var_377.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
