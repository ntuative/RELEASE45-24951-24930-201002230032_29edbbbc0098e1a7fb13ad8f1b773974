package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1160:int = const_293;
      ...
      public static const const_536:int = 6;
      
      public static const const_217:int = const_80;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1348 == const_80)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_431);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_431,var_23.width,var_431);
         }
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_729,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_431,param6,param7);
                     return param1;
                  }
                  return var_23;
               }
