package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_971:Point = null;
      
      private var var_470:Array;
      
      private var var_972:LayoutRasterizerData = null;
      ...
      private var var_468:Boolean = true;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_973 = param1;
         var _loc3_:LayoutRasterizerData = var_54.getValue(var_656);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1181 = RoomObjectVariableEnum.const_873;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1181 = RoomObjectVariableEnum.const_912;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_973 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_973 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_973 + _adBgIndex);
            _loc5_ = param1.getSprite(var_973 + _adImgIndex);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1902);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function dispose() : void
      {
         ...
         if(var_54 != null)
         {
            ...
            {
               _loc2_ = var_54.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_656)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_972 = var_54.getValue(var_656);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_54.getValue(var_656);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_972.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_971.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_971.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_317.indexOf(_loc10_) >= 0 && var_468)
            {
               param1 = var_317.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_469[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_470[param1];
               }
               var_317.splice(param1,1);
               var_469.splice(param1,1);
               var_470.splice(param1,1);
               if(false)
               {
                  var_468 = false;
               }
