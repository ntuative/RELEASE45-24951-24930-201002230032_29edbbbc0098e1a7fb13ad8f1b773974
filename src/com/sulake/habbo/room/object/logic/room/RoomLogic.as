package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1410:int = 1500;
      
      private var var_1409:int = 255;
      
      private var var_1408:int = 255;
      
      private var var_1161:uint = 16777215;
      
      private var var_953:uint = 16777215;
      
      protected var var_71:RoomPlaneParser = null;
      
      private var var_784:int = 0;
      
      private var var_1162:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_639:
                  _loc2_.setString(RoomObjectVariableEnum.const_482,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_698:
                  _loc2_.setString(RoomObjectVariableEnum.const_702,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_670:
                  _loc2_.setString(RoomObjectVariableEnum.const_710,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_462:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_205)
                  {
                     _loc8_ = "null";
                  }
                  var_402.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_503:
                  _loc7_ = var_402.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_402.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_932,_loc10_);
            }
            return;
         }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_71.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_862,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_71.planeCount)
         {
            if(param1.type == MouseEvent.ROLL_OUT)
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_65,0);
            }
            return;
         }
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_71.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_71.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_71.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_71.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_71.getPlaneNormal(_loc5_);
         var _loc13_:int = var_71.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1153,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1287,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1163,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_65,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_124)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_134 || _loc13_ == RoomPlaneData.const_248)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_784)
         {
            ...
            {
               _loc7_ = var_1161 >> 16 & 255;
               _loc8_ = var_1161 >> 8 & 255;
               _loc9_ = var_1161 & 255;
               _loc10_ = var_953 >> 16 & 255;
               _loc11_ = var_953 >> 8 & 255;
               _loc12_ = var_953 & 255;
               _loc13_ = (_loc2_ - var_784) / var_1410;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1409 + (var_1408 - var_1409) * _loc13_;
               _color = _loc3_;
               var_1162 = _loc4_;
            }
