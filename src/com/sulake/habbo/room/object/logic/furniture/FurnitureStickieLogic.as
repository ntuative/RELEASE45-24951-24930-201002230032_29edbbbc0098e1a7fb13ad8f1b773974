package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            _loc2_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_101,object.getId(),object.getType());
            if(_loc2_ != null)
            {
      ...
      private function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            _loc1_ = object.getModel().getString(RoomObjectVariableEnum.const_127);
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_212,_loc3_ + 1);
         }
      }
   }
}
