package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         var_118 = new ByteArray();
         var_45 = 0;
         while(var_45 < psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = var_45++;
            var_118[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            var_118[_loc4_ = var_45++] = _loc2_ & 255;
         }
         var_45 = 0;
         seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = var_45++;
         var_118[_loc2_] = 0 ^ param1 & 255;
         var _loc3_:* = var_45++;
         var_118[_loc3_] = 0 ^ param1 >> 8 & 255;
         var _loc4_:*;
         var_118[_loc4_ = var_45++] = 0 ^ param1 >> 16 & 255;
         var _loc5_:*;
         var_118[_loc5_ = var_45++] = 0 ^ param1 >> 24 & 255;
         var_45 %= psize;
         var_1682 = true;
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < var_118.length)
         {
            var_118[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         var_118.length = 0;
         var_118 = null;
