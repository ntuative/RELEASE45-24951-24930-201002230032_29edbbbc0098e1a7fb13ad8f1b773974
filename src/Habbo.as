package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_5:String = "client.init.start";
      
      private static const const_1:String = "client.starting";
      
      private static const const_2:Number = 0.29;
      
      public static const const_4:String = "client.init.swf.loaded";
      
      public static const const_3:String = "client.init.volter.loaded";
      
      public static const const_6:String = "client.init.volter.retry";
      ...
      {
         var _loc3_:* = null;
         var _loc2_:TextField = param1.getChildByName("textField") as TextField;
         if(_loc2_)
         {
            _loc2_.x = 191 - _loc2_.width / 2;
            _loc3_ = param1.getChildByName("habboLogo") as Bitmap;
            if(_loc3_)
            {
      ...
      private static function positionLoadingScreenDisplayElements(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc3_:Sprite = param1.getChildByName("background") as Sprite;
         if(_loc3_)
         {
            _loc3_.x = 0;
            _loc3_.y = 0;
         ...
         var _loc4_:Bitmap = param1.getChildByName("habboLogo") as Bitmap;
         if(_loc4_)
         {
            _loc4_.x = 117;
            _loc4_.y = 57;
         ...
         var _loc5_:Sprite = param1.getChildByName("loadingBar") as Sprite;
         if(_loc5_)
         {
            _loc5_.x = 89;
            _loc5_.y = 149;
      ...
      public function createLoadingScreen() : DisplayObjectContainer
      {
         ...
         _loc3_.name = "habboLogo";
         _loc1_.addChild(_loc3_);
         var _loc4_:TextField = new TextField();
         _loc4_.name = "textField";
         if(stage.loaderInfo.parameters[const_1] != null)
         {
            _loc4_.text = stage.loaderInfo.parameters[const_1];
         }
         else
         {
            _loc4_.text = const_1;
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         if(!var_2)
         {
            ...
            nextFrame();
            _loc2_ = Class(getDefinitionByName("HabboMain"));
            if(_loc2_)
            {
               _loc3_ = new _loc2_(var_1) as DisplayObject;
               if(_loc3_)
               {
      ...
      private function onPreLoadingProgress(param1:Event) : void
      {
         if(var_1)
         {
            updateLoadingBar(var_1,root.loaderInfo.bytesLoaded / root.loaderInfo.bytesTotal * const_2);
         }
      }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = param1.getChildByName("background");
         if(_loc2_)
         {
            param1.removeChild(_loc2_);
         }
         _loc2_ = param1.getChildByName("textField");
         if(_loc2_)
         {
            param1.removeChild(_loc2_);
         }
         _loc2_ = param1.getChildByName("habboLogo");
         if(_loc2_)
         {
            param1.removeChild(_loc2_);
         }
         _loc2_ = param1.getChildByName("loadingBar");
         if(_loc2_)
         {
            param1.removeChild(_loc2_);
         }
      ...
      private function onVolterLoadingCompleted(param1:Event) : void
      {
         ...
         if(var_1)
         {
            updateFont(var_1.getChildByName("textField") as TextField,"Volter",true);
